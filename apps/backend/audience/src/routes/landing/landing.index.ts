import { redis } from "@reloop/audience/utils/loader";
...
╠════════════════════════════════════════════════════════════════╣
║ QUICK START:                                                   ║
║ curl -X GET /api/audience/check \\                              ║
║   -H "Content-Type: application/json" \\                        ║
║   -d '{"audience":"example@domain.com"}'                       ║
╠════════════════════════════════════════════════════════════════╣
║ - SUPPORT                                                      ║
║ - https://reloop.sh/dev/setup/backend/audience                 ║
...
`;
		},
		{
			detail: {
				tags: ["Service"],
				summary: "Health check for Audience Service",
				description: "Checks the health of the Audience Service",
			},
		},
	)
	.get(
