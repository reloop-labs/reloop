...
export namespace WebhookTypes {
    ...
    export type WebhookListResponse = typeof WebhookModel.webhookListResponse.static;
    ...
    export type WebhookAlreadyExists = typeof WebhookModel.webhookAlreadyExists.static;
