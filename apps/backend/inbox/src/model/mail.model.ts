...
export namespace MailModel {
	...
	export const threadMessageItem = t.Object({
		...
		threadId: t.String(),
		direction: t.String(),
		inboundEmailId: t.Union([t.String(), t.Null(), t.Undefined()]),
		emailLogId: t.Union([t.String(), t.Null(), t.Undefined()]),
		fromEmail: t.String(),
		fromName: t.Union([t.String(), t.Null(), t.Undefined()]),
		subject: t.Union([t.String(), t.Null(), t.Undefined()]),
		preview: t.Union([t.String(), t.Null(), t.Undefined()]),
		messageAt: t.Union([t.Date(), t.String()]),
		errorMessage: t.Union([t.String(), t.Null(), t.Undefined()]),
		rfc822MessageId: t.Union([t.String(), t.Null(), t.Undefined()]),
		inReplyTo: t.Union([t.String(), t.Null(), t.Undefined()]),
		createdAt: t.Union([t.Date(), t.String()]),
		email: t.Union([
