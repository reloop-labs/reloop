export const rotateApiKeyXCodeSamples = [
	{
		id: "node",
		lang: "javascript",
		label: "Node.js",
...
const apiKey = await reloop.apiKey.rotate("key_123456789");`,
	},
	{
		id: "curl",
		lang: "bash",
		label: "cURL",
		source: `curl -X POST https://api.reloop.sh/api-key/v1/rotate/key_123456789 \\
