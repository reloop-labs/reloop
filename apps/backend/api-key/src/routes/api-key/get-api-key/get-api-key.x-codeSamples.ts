...
const { response, error } = await reloop.apiKey.get("key_123456789");
if (error) throw error;`,
  },
  {
    ...
    lang: "bash",
    label: "cURL",
    source: `curl "https://reloop.sh/api/api-key/v1/key_123456789" \\
...
{:ok, result} = Reloop.Services.ApiKey.get(client, "key_123456789")`,
  }
];
