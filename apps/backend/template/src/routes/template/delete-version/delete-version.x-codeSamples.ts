...
await reloop.template.deleteVersion("tpl_123456789", "ver_123456789");`,
	},
	{
		...
		lang: "bash",
		label: "cURL",
		source: `curl -X DELETE https://api.reloop.sh/template/v1/tpl_123456789/versions/ver_123456789 \\
...
response = requests.delete(
    "https://api.reloop.sh/template/v1/tpl_123456789/versions/ver_123456789",
    headers={
...
$client->delete('https://api.reloop.sh/template/v1/tpl_123456789/versions/ver_123456789', [
    'headers' => [
        'Authorization' => 'Bearer rl_123456789',
    ],
]);`,
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://api.reloop.sh/template/v1/tpl_123456789/versions/ver_123456789"))
