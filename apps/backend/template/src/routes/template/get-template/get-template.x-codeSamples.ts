export const getTemplateXCodeSamples = [
	{
		id: "node",
		lang: "javascript",
		label: "Node.js",
...
const template = await reloop.template.retrieve("tpl_123456789");`,
	},
	{
		id: "curl",
		lang: "bash",
		label: "cURL",
		source: `curl https://api.reloop.sh/template/v1/tpl_123456789 \\
