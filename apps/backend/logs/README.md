...
- 📚 **Documentation**: [Developer Docs](https://reloop.sh/dev/logs-service)
...
- `POST /api/logs/v1` for single structured log ingest
- `POST /api/logs/v1/bulk` for batch structured log ingest
...
- 🛠️ **Setup**: [Setup Guide](https://reloop.sh/docs/setup/backend/logs)
