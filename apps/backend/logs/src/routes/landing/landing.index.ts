...
║ 📖 Swagger: https://reloop.sh/api/logs/swagger                      ║
...
`;
	...
	.get("/agent-card.json", () => ({
		name: "Logs Service",
		version: "1.0.0",
		description: "Unified logging service for tracking system events, email delivery status, and click/open tracking using ClickHouse.",
		url: "https://reloop.sh",
		...
		skills: [
			{
				id: "health_check",
				name: "Health Check",
				description: "Verify the connection status of the Logs service, Redis, and ClickHouse.",
				method: "GET",
			...
			},
			{
				...
				description: "Retrieve a paginated list of email delivery logs, filtered by organization or recipient.",
				method: "GET",
			...
			},
			{
				...
				description: "Retrieve aggregated statistics for email deliveries (sent, delivered, opened, clicked, bounced).",
				method: "GET",
