...
export function generateDomainCacheKey(
	domain: string,
...
export function generateDNSRecordsCacheKey(
	domain: string,
	organizationId: string,
): string {
...
export function generateDomainListCacheKey(
	organizationId: string,
	query: object,
): string {
...
export function generateDKIMKeysCacheKey(
	domain: string,
	organizationId: string,
): string {
...
export async function invalidateDomainListCache(
	organizationId: string,
): Promise<void> {
	try {
...
export async function invalidateDNSRecordsCache(
	domain: string,
	organizationId: string,
): Promise<void> {
	try {
