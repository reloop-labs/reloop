const PREFERENCES_SECRET =
  process.env.PREFERENCES_SECRET || "reloop-preferences-secret-key-change-in-prod";
...
export async function signToken(payload: PreferencesTokenPayload): Promise<string> {
