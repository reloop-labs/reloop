export const updateContactTopicXCodeSamples = [
  {
    id: "node",
    lang: "js",
    label: "Node.js",
...
const response = await reloop.audience.topics.updateStatus('top_987654321', {
  ...
  },
  {
    ...
    lang: "bash",
    label: "cURL",
    source: `curl -X PATCH https://reloop.sh/api/contacts/v1/topic/top_987654321 \\
...
$response = $client->patch('https://reloop.sh/api/contacts/v1/topic/top_987654321', [
    'headers' => [
...
func main() {
  ...
  req, _ := http.NewRequest("PATCH", "https://reloop.sh/api/contacts/v1/topic/top_987654321", bytes.NewBuffer(body))
...
async fn main() -> Result<(), reqwest::Error> {
    ...
    let response = client
        .patch("https://reloop.sh/api/contacts/v1/topic/top_987654321")
