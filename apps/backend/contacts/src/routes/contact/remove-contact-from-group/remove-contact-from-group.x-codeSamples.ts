...
$response = $client->delete('https://reloop.sh/api/contacts/group/grp_123456789', [
    'headers' => [
...
func main() {
  ...
  req, _ := http.NewRequest("DELETE", "https://reloop.sh/api/contacts/group/grp_123456789", bytes.NewBuffer(body))
...
async fn main() -> Result<(), reqwest::Error> {
    ...
    let response = client
        .delete("https://reloop.sh/api/contacts/group/grp_123456789")
...
HttpRequest request = HttpRequest.newBuilder()
    ...
    .method("DELETE", BodyPublishers.ofString("{\\"contact_id\\": \\"cont_123456789\\"}"))
    .build();
...
var request = new HttpRequestMessage(HttpMethod.Delete, "https://reloop.sh/api/contacts/group/grp_123456789");
