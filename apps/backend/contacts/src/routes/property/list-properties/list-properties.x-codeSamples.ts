...
$properties = $reloop->contacts->listProperties(new ListPropertiesParams(
    page: 1,
    limit: 10,
));`,
	},
...
func main() {
  req, _ := http.NewRequest("GET", "https://reloop.sh/api/contacts/v1/properties/list?page=1&limit=10", nil)
