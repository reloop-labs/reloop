export const deletePropertyXCodeSamples = [
	{
		id: "node",
		lang: "js",
		label: "Node.js",
...
$response = $client->delete('https://reloop.sh/api/contacts/v1/properties/prop_123456789', [
...
func main() {
  req, _ := http.NewRequest("DELETE", "https://reloop.sh/api/contacts/v1/properties/prop_123456789", nil)
...
async fn main() -> Result<(), reqwest::Error> {
    ...
    let response = client
        .delete("https://reloop.sh/api/contacts/v1/properties/prop_123456789")
