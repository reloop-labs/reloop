...
func main() {
    ...
    _, _ = reloop.Contacts().Channels.List(map[string]interface{}{
        "page": 1,
        "limit": 10
    })
}`,
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    reloop.contacts().channels().list(json!({
        "page": 1,
        "limit": 10,
    })).await?;
...
await reloop.Contacts().Channels.ListAsync(new Dictionary<string, object?>
{
    ["page"] = 1,
    ["limit"] = 10,
});`,
