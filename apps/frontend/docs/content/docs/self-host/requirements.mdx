...
> [!NOTE]
> SSD/NVMe storage is highly recommended. ClickHouse and PostgreSQL write extensive analytical telemetry logs, which require fast disk I/O speeds to prevent latency.
