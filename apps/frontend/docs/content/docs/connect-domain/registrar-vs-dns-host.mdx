...
2. Or look up nameservers — see [Find your DNS provider](/docs/connect-domain/find-dns-provider).
...
If Auto-populate or verification fails after you “added records,” you almost always edited the wrong panel. See [Wrong nameservers](/docs/connect-domain/troubleshoot/wrong-nameservers).
