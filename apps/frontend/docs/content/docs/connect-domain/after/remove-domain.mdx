...
You can add the same domain again later and re-verify, subject to [already registered](/docs/connect-domain/troubleshoot/domain-already-registered) rules if another org holds it.
