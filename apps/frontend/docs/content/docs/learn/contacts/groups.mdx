...
faq:
  ...
  - question: How do I add contacts to a group?
    answer: Open the group in the dashboard and use Add Contacts to Group, or call the Groups API to add a member by contact ID or email.
...
Open the group in the dashboard and use **Add Contacts to Group**, or call the Groups API to add a member by contact ID or email.
