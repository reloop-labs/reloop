...
<Tabs>
  <Tab title="Desktop" icon="monitor">
    ![Add a contact in the Reloop dashboard](/docs/images/docs/contacts/overview/add-contact.gif)
...
<Tabs>
  <Tab title="Desktop" icon="monitor">
    ![Search and filter contacts](/docs/images/docs/contacts/overview/search-filter.gif)
...
<Tabs>
  <Tab title="Desktop" icon="monitor">
    ![Contact row actions](/docs/images/docs/contacts/overview/list-view.png)
...
<Tabs>
  <Tab title="Desktop" icon="monitor">
    ![Delete a contact from the list](/docs/images/docs/contacts/overview/delete-contact.gif)
