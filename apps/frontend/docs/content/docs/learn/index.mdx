...
<CardGroup cols={3}>
  ...
  <Card title="Emails" icon="Send" href="/learn/emails">
    Send transactional emails at scale with guaranteed delivery and rich styling.
  </Card>
  <Card title="Metrics" icon="Activity" href="/learn/metrics">
  ...
  <Card title="Templates" icon="FileText" href="/learn/templates">
    Build reusable and dynamic email layouts using Lexical or raw HTML.
  </Card>
  <Card title="API Keys" icon="Key" href="/learn/api-keys">
    Manage fine-grained API credentials and rotate tokens securely.
  </Card>
  <Card title="Logs" icon="Database" href="/learn/logs">
  ...
  <Card title="Workflows" icon="Zap" href="/learn/workflows">
    Create visual automated flows, drip campaigns, and auto-responders.
  </Card>
  <Card title="Settings" icon="Settings" href="/learn/settings">
