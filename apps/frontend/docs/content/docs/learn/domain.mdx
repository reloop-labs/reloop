...
<Tabs>
  <Tab title="Desktop" icon="monitor">
    ...
    After you add a domain, Reloop shows the required DNS records (SPF, DKIM, DMARC, and receiving/tracking rows based on your toggles). Sending does not require MX.
