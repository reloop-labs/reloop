...
<Note>
Make sure you have a [verified domain](/learn/domains) with receiving enabled.
</Note>

## Closing the loop with webhooks

The `webhooks listen` command subscribes to [webhook events](/learn/webhooks) and streams them to your terminal:
