---
title: Next.js
description: This guide explains how to integrate Rybbit with your Next.js application, including implementing the ad blocker bypass.
---
...
While Rybbit is not using any cookied based tracking and is fully compliant with GDPR, CCPA, and other privacy regulations, some ad blockers may still aggressively block it no matter how the tracking is implemented or operated.
