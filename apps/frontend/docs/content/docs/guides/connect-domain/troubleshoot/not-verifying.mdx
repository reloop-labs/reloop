...
> [!NOTE]
> Self-hosting? If every record fails at once and `dig` from the host shows them
> fine, the containers cannot reach a resolver. See
> [Network Requirements](/docs/self-host/requirements#network-requirements).
