...
<Steps>
  ...
  <Step title="Publish DNS records">
    Either complete the Domain Connect consent flow, or copy every required record into your DNS panel. Do not skip DKIM, SPF, or DMARC when Email Sending is on.
  </Step>
  <Step title="Verify">
