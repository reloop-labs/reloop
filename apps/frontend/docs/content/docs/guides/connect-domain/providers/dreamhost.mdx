...
<AccordionGroup>
  <Accordion title="Verification failed after I added records">
    Re-open the Reloop domain page and compare every Type / Host / Value to DreamHost. Fix typos, truncated DKIM keys, and duplicate SPF records. Then click **Verify Domain** again.
  </Accordion>
