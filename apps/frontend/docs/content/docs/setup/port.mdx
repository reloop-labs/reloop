...
| [https://local.reloop.sh/api/campaigns](https://local.reloop.sh/api/campaigns) | [Campaigns](/docs/setup/backend/campaigns) | `8027` |
| [https://local.reloop.sh/api/inbox](https://local.reloop.sh/api/inbox) | [Inbox](/docs/setup/backend/inbox) | `8028` |
...
| [Campaigns](/docs/setup/backend/campaigns) | [`/api/campaigns`](https://local.reloop.sh/api/campaigns) | `8027` |
| [Inbox](/docs/setup/backend/inbox) | [`/api/inbox`](https://local.reloop.sh/api/inbox) | `8028` |
