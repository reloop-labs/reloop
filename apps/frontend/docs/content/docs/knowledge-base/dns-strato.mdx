...
sidebarTitle: "Strato"
description: "How to add Reloop DNS records in Strato."
---

Learn how to configure Reloop DNS records with Strato.

## Prerequisites

- A [verified domain](https://app.reloop.dev/domains) in Reloop
- Access to your Strato DNS management panel

## Adding DNS Records

<Steps>
  <Step title="Log in to Strato">
    Go to your Strato dashboard and navigate to the DNS management section for your domain.
  </Step>
