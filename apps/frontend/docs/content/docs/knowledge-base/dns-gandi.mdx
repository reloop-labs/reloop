...
sidebarTitle: "Gandi"
description: "How to add Reloop DNS records in Gandi."
---

Learn how to configure Reloop DNS records with Gandi.

## Prerequisites

- A [verified domain](https://app.reloop.dev/domains) in Reloop
- Access to your Gandi DNS management panel

## Adding DNS Records

<Steps>
  <Step title="Log in to Gandi">
    Go to your Gandi dashboard and navigate to the DNS management section for your domain.
  </Step>
