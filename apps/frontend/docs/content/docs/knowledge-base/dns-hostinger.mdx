...
description: "How to add Reloop DNS records in Hostinger."
---

Learn how to configure Reloop DNS records with Hostinger.

## Prerequisites

- A [verified domain](https://app.reloop.dev/domains) in Reloop
- Access to your Hostinger DNS management panel

## Adding DNS Records

<Steps>
  <Step title="Log in to Hostinger">
    Go to your Hostinger dashboard and navigate to the DNS management section for your domain.
  </Step>
