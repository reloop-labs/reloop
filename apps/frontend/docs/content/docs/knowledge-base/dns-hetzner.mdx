...
description: "How to add Reloop DNS records in Hetzner."
---

Learn how to configure Reloop DNS records with Hetzner.

## Prerequisites

- A [verified domain](https://app.reloop.dev/domains) in Reloop
- Access to your Hetzner DNS management panel

## Adding DNS Records

<Steps>
  <Step title="Log in to Hetzner">
    Go to your Hetzner dashboard and navigate to the DNS management section for your domain.
  </Step>
