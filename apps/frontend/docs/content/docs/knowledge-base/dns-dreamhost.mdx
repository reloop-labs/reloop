...
description: "How to add Reloop DNS records in DreamHost."
---

Learn how to configure Reloop DNS records with DreamHost.

## Prerequisites

- A [verified domain](https://app.reloop.dev/domains) in Reloop
- Access to your DreamHost DNS management panel

## Adding DNS Records

<Steps>
  <Step title="Log in to DreamHost">
    Go to your DreamHost dashboard and navigate to the DNS management section for your domain.
  </Step>
