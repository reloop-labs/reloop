...
sidebarTitle: "IONOS"
description: "How to add Reloop DNS records in IONOS."
---

Learn how to configure Reloop DNS records with IONOS.

## Prerequisites

- A [verified domain](https://app.reloop.dev/domains) in Reloop
- Access to your IONOS DNS management panel

## Adding DNS Records

<Steps>
  <Step title="Log in to IONOS">
    Go to your IONOS dashboard and navigate to the DNS management section for your domain.
  </Step>
