...
description: "How to add Reloop DNS records in AWS Route 53."
---

Learn how to configure Reloop DNS records with AWS Route 53.

## Prerequisites

- A [verified domain](https://app.reloop.dev/domains) in Reloop
- Access to your AWS Route 53 DNS management panel

## Adding DNS Records

<Steps>
  <Step title="Log in to AWS Route 53">
    Go to your AWS Route 53 dashboard and navigate to the DNS management section for your domain.
  </Step>
