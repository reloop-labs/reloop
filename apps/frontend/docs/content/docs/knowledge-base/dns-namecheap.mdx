...
description: "How to add Reloop DNS records in Namecheap."
---

Learn how to configure Reloop DNS records with Namecheap.

## Prerequisites

- A [verified domain](https://app.reloop.dev/domains) in Reloop
- Access to your Namecheap DNS management panel

## Adding DNS Records

<Steps>
  <Step title="Log in to Namecheap">
    Go to your Namecheap dashboard and navigate to the DNS management section for your domain.
  </Step>
