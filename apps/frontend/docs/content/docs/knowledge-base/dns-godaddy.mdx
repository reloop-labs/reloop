...
description: "How to add Reloop DNS records in GoDaddy."
---

Learn how to configure Reloop DNS records with GoDaddy.

## Prerequisites

- A [verified domain](https://app.reloop.dev/domains) in Reloop
- Access to your GoDaddy DNS management panel

## Adding DNS Records

<Steps>
  <Step title="Log in to GoDaddy">
    Go to your GoDaddy dashboard and navigate to the DNS management section for your domain.
  </Step>
