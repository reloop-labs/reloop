---
title: Send Email with Django
sidebarTitle: Django
description: Send transactional email from Django with the Reloop Python SDK. Includes pip install, settings.py API key setup, and a complete send example.
icon: siDjango
---
