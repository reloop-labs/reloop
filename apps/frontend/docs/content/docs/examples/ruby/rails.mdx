...
sidebarTitle: Rails
description: Send transactional email from Ruby on Rails with the Reloop Ruby SDK. Includes Gemfile setup, credentials config, and a complete send example.
icon: siRubyonrails
---
