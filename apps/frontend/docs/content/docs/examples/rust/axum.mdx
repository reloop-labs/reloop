---
title: Send Email with Axum
sidebarTitle: Axum
description: Send transactional email from an Axum Rust app with the Reloop SDK. Includes Cargo dependencies and a complete HTTP handler send example.
icon: siRust
---
