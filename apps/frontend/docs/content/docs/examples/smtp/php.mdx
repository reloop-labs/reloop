...
[View complete runnable example on GitHub ↗](https://github.com/reloop-labs/reloop/tree/main/examples/smtp-php)
...
try {
    ...
    // Recipients
    $mail->setFrom('onboarding@yourdomain.com', 'Onboarding');
