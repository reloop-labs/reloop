---
title: Send Email with PHPMailer SMTP
sidebarTitle: PHP
description: Send transactional email via Reloop SMTP using PHPMailer. Includes Composer install, TLS auth settings, and a complete runnable PHP code example.
---
