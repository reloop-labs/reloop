---
title: Send Email with Python SMTP
sidebarTitle: Python
description: Send transactional email via Reloop using Python smtplib and email.mime. Copy-paste SMTP example with TLS, API key auth, and HTML body.
---
