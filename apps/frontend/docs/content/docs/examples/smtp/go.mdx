---
title: Send Email with Go net/smtp
sidebarTitle: Go
description: Send transactional email via Reloop SMTP using Go's net/smtp package. Full TLS example with API key auth, recipients, and an HTML body.
---
