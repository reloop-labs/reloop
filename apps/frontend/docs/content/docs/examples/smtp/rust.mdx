---
title: Send Email with Lettre SMTP
sidebarTitle: Rust
description: Send transactional email via Reloop SMTP in Rust with the Lettre crate. Includes Cargo setup, TLS auth, and a complete send example.
---
