---
title: SMTP Relay for Transactional Email
sidebarTitle: Introduction
description: Connect any SMTP client to Reloop's transactional email relay. Host, ports, TLS, and API key auth for Nodemailer, PHPMailer, Python, Go, Ruby, and Rust.
---
...
<CardGroup cols={3}>
  <Card icon="siNodedotjs" title="Nodemailer (Node.js)">
    ...
    <span className="mt-4 flex gap-4 text-xs font-semibold">
...
<RelatedTopics>
  ...
  <RelatedTopic icon="code" title="All Examples Overview" href="/docs" />
