...
_openapi:
  ...
  structuredData:
    headings: []
    contents:
      - content: "Restores a template to a specific historical version"
_apiData:
  document: "https://reloop.sh/api/template/openapi/json"
  operationData: [{"path":"/api/template/v1/{id}/versions/{versionId}/restore","method":"post"}]
  ...
  codeSamples:
    ...
    - id: curl
      ...
      label: cURL
      source: |-
        curl -X POST https://api.reloop.sh/template/v1/tpl_123456789/versions/ver_123456789/restore \\
