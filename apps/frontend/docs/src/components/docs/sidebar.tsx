...
export function Sidebar({
	...
	return (
		...
		>
			...
			<nav
				ref={navRef}
				className="scrollbar-thin relative flex-1 overflow-y-auto pt-0 pr-1.5 pb-0 pl-1 [scrollbar-color:--alpha(var(--foreground)/20%)_transparent] [scrollbar-width:thin]"
