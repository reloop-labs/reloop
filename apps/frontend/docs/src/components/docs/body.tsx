	...
	return (
		<div
			className={cn(
				...
				"prose-p:text-[15px] prose-p:text-[#171717]/80 dark:prose-p:text-white/80 prose-p:leading-7",
				"prose-a:font-medium prose-a:text-[#171717] dark:prose-a:text-white prose-a:no-underline",
