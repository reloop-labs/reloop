...
export function PageActions({
	...
	return (
		<div className="relative inline-flex w-fit items-center rounded-xl border border-stroke-soft-100 text-sm">
			<button
				type="button"
				onClick={() => onCopy()}
				disabled={isLoading}
			...
			{isOpen && (
				<>
					...
					{/*
					  ...
					  Cap width so it never overflows the viewport.
					*/}
					<div className="absolute top-full left-0 z-50 mt-1 w-[min(340px,calc(100vw-2.5rem))] rounded-2xl border border-stroke-soft-100 bg-bg-white-0 p-1.5 shadow-lg sm:right-0 sm:left-auto dark:bg-[#0a0a0a]">
