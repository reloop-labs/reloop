	...
	return (
		<div className="relative flex items-center rounded-xl border border-stroke-soft-100 bg-bg-soft-200 text-sm">
			...
			>
				...
				<span className="font-medium text-[#171717] dark:text-white">Copy page</span>
			</button>
					...
					<>
						...
						<div className="absolute top-full right-0 z-50 mt-1 w-[340px] rounded-2xl border border-stroke-soft-100 bg-bg-white-0 p-1.5 shadow-lg dark:bg-[#0a0a0a]">
							<button
								...
								className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left transition-colors hover:bg-bg-soft-200"
							>
								<div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-bg-soft-200 text-text-sub-600">
