					...
					<div className="flex h-full flex-col gap-8 sm:gap-12 lg:flex-row lg:items-stretch lg:gap-16">
						<div className="flex shrink-0 lg:w-40">
							<div className="-ml-2 -mt-2 flex shrink-0 flex-col">
								...
								>
									<Logo className="size-9 text-text-strong-950 sm:size-10 dark:text-white" />
									<span className="-ml-1.5 sm:-ml-2.5 font-semibold text-[15px] text-text-strong-950 tracking-tight sm:text-[16px] dark:text-white">
										Reloop
									</span>
								</a>
							</div>
