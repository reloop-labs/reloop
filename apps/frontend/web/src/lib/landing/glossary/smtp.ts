...
export const term: GlossaryTermDefinition = {
	...
	title: "SMTP",
	description:
		"Simple Mail Transfer Protocol. The language servers use to relay email across the internet.",
...
Reloop offers SMTP relay alongside HTTP APIs so legacy apps can keep their existing mail libraries.`,
	relatedTerms: [
		{
			slug: "mta",
			title: "MTA",
