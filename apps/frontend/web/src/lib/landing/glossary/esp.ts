...
export const term: GlossaryTermDefinition = {
	...
	title: "ESP",
	description:
		"A company or product that sends and manages email for you (Email Service Provider).",
	keywords: ["email service provider","ESP","email platform"],
	body: `An ESP provides infrastructure and software for outbound email: APIs, SMTP injection, templates, analytics, and compliance tools. Some focus on marketing campaigns, some on transactional product mail, some on both.
