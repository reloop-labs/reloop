...
export const term: GlossaryTermDefinition = {
	...
	description:
		"How mailbox providers score your sending domain based on past behavior and trust signals.",
	keywords: ["domain reputation email","sender domain score"],
	body: `Domain reputation is the trust score attached to the domain in your From address (and related authenticated domains). Providers build it from complaints, bounces, engagement, spam trap hits, and authentication history. It is not a public number you can always look up; you infer it from placement and postmaster tools.

A new domain starts with little history. Sudden volume looks suspicious. Warming and consistent, wanted mail help. Parking a domain for years then blasting from it does not.
