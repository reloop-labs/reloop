...
export const term: GlossaryTermDefinition = {
	...
	description:
		"Addresses you must not mail: unsubscribes, complaints, hard bounces, and manual blocks.",
	keywords: ["suppression list","email suppression","do not email list"],
	body: `A suppression list is the set of addresses excluded from sends regardless of campaign audience rules. It includes unsubscribes, spam complainers, hard bounces, and sometimes legal or manual blocks.
