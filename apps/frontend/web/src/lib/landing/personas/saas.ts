			...
			items: [
				{
					title: "Onboarding",
					description:
						"Welcome, verify, and activate new trial users automatically.",
				},
				{
					title: "Billing",
					description:
						"Receipts, failed payment, and renewal emails via Stripe webhooks.",
				},
				{
					title: "Engagement",
					description:
						"Re-engagement and upgrade nudges based on product usage.",
				},
			],
		},
	],
