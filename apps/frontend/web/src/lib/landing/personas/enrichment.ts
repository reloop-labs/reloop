...
export const personaEnrichment: Record<string, PersonaEnrichment> = {
	developers: {
		...
		painPoints: [
			"Opaque black-box ESPs",
			"Missing webhooks & logs",
			"No self-host option",
		],
	...
	saas: {
		...
		painPoints: [
			"Auth emails off-brand",
			"Billing receipts manual",
			"Churn on failed renewals",
		],
		wins: [
			"Stripe webhook recipes",
	...
	agencies: {
		...
		painPoints: [
			"Per-client ESP accounts",
			"Deliverability fire drills",
			"Reporting scattered",
		],
		wins: [
	...
	enterprises: {
		...
		painPoints: [
			...
			"Unpredictable SaaS costs",
		],
		wins: [
			"Deploy on your VPC",
			"Apache 2.0 audit",
			"Same product hosted or self-run",
		],
	},
