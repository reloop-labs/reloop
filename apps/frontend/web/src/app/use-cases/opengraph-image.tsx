...
export const alt = "Email Use Cases for Developers | Reloop";
		...
		>
			...
			>
				...
				>
					...
					>
						Copy production-ready code for transactional alerts, drip flows, AI
						agent inboxes, and webhooks. Every use case includes an API snippet.
					</span>
				</div>
				...
				{[
					{
						...
						badgeColor: "#818cf8",
						desc: "Give LLM agents a real inbox to read, draft, and reply to email.",
					},
					{
						...
						badgeColor: "#60a5fa",
						desc: "Deliver critical magic links, password resets, and receipts.",
					},
					{
						...
						badgeColor: "#22d3ee",
						desc: "Parse incoming messages and route them straight to your app.",
					},
				].map((item, idx) => (
					<div
						key={idx}
