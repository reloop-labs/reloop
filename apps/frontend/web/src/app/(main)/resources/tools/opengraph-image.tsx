...
export const alt = "Free Email Tools | Reloop";
...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				<div style={{ display: "flex", flexDirection: "column", gap: "12px", margin: "24px 0" }}>
					<span style={{ fontSize: "48px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px" }}>Free Email Tools</span>
					<span style={{ fontSize: "18px", color: "rgba(255, 255, 255, 0.5)", lineHeight: "1.4" }}>Validate domains, inspect records, and debug email headers with our free utility suite.</span>
				</div>
    ...
    {
        "title": "SPF Validator",
        "desc": "Ensure your Sender Policy Framework records are correct."
    },
    {
        "title": "DKIM Inspector",
        "desc": "Verify DomainKeys Identified Mail signatures and key lengths."
    },
    {
        "title": "DMARC Advisor",
        "desc": "Check DMARC alignment and policy configurations."
    }
]).map((item, idx) => (
					<div
						key={idx}
