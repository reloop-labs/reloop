...
export const alt = "Self-Hosting Guide | Reloop";
...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				<div style={{ display: "flex", flexDirection: "column", gap: "12px", margin: "24px 0" }}>
					<span style={{ fontSize: "48px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px" }}>Self-Hosting Guide</span>
					<span style={{ fontSize: "18px", color: "rgba(255, 255, 255, 0.5)", lineHeight: "1.4" }}>Deploy Reloop on your own servers and cloud infrastructure using Docker and Kubernetes.</span>
				</div>
    ...
    {
        "title": "Docker Setup",
        "desc": "Spin up a complete Reloop instance with a single command."
    },
    {
        "title": "Database Config",
        "desc": "Connect PostgreSQL for user accounts and analytics storage."
    },
    {
        "title": "NATS Queue",
        "desc": "Setup event queuing for ultra-fast, asynchronous email delivery."
    }
]).map((item, idx) => (
					<div
						key={idx}
