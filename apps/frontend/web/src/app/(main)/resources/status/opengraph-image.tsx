...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				>
					...
					>
						Real-time service status, API latencies, and deliverability monitoring reports.
					</div>
				</div>
    ...
    {
        "title": "API Gateway",
        "desc": "Operational \u2022 99.99% uptime with sub-10ms response latency."
    },
    {
        "title": "SMTP Relay MTA",
        "desc": "Operational \u2022 Under 50ms queue latency across global regions."
    },
    {
