...
export const alt = "System Status | Reloop";
...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				<div style={{ display: "flex", flexDirection: "column", gap: "12px", margin: "24px 0" }}>
					<span style={{ fontSize: "48px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px" }}>System Status</span>
					<span style={{ fontSize: "18px", color: "rgba(255, 255, 255, 0.5)", lineHeight: "1.4" }}>Real-time service status, API latencies, and deliverability monitoring reports.</span>
				</div>
    ...
    {
        "title": "API Gateway",
        "desc": "Operational \u2022 Uptime with sub-10ms response latency."
    },
    {
        "title": "SMTP Relay MTA",
        "desc": "Operational \u2022 Low queue latency across global regions."
    },
    {
        "title": "Webhook Deliveries",
        "desc": "Operational \u2022 100% processing rate with secure HMAC validation."
    }
]).map((item, idx) => (
					<div
						key={idx}
