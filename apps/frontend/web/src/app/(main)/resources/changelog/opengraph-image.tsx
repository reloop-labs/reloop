...
export default function OpenGraphImage() {
		...
		>
			...
			<div style={{ display: "flex", flexDirection: "column", width: "100%" }}>
				...
				<div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
					...
					<span style={{ fontSize: "22px", fontWeight: 500, color: "rgba(255, 255, 255, 0.6)", letterSpacing: "-0.5px", marginLeft: "8px" }}>Resources</span>
				</div>

				<div style={{ display: "flex", flexDirection: "column", marginTop: "24px" }}>
					<span style={{ fontSize: "52px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px" }}>Changelog</span>
					<span style={{ fontSize: "18px", color: "rgba(255, 255, 255, 0.5)", marginTop: "10px", maxWidth: "900px" }}>Stay up to date with the latest features, improvements, and releases for Reloop.</span>
				</div>
			</div>
    ...
    {
        "title": "Version 1.0.0",
        "desc": "Public launch of our open-source email infrastructure platform."
    },
    {
        "title": "Sandbox MTA",
        "desc": "Local development SMTP server release for offline testing."
    },
    {
        "title": "SDK Releases",
        "desc": "Type-safe client library updates for modern backend languages."
    }
]).map((item, idx) => (
					<div
						key={idx}
