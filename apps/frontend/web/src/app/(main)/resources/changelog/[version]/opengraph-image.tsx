...
export const alt = "[Version] | Reloop";
...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				>
					...
					>
						Open-source, self-hostable email infrastructure—with a hosted service from Reloop Labs.
					</div>
				</div>
				...
				{([
    {
        ...
        "desc": "Apache 2.0 licensed codebase, free to audit and self-host."
    },
    {
        "title": "Simple Integration",
        "desc": "Integrate email operations via standard SMTP and APIs."
    },
    {
        "title": "Zero Lock-In",
        "desc": "Deploy on your own infrastructure or use our hosted platform."
    }
]).map((item, idx) => (
					<div
						key={idx}
