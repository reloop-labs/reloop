 ...
 * (Planning, Design, Frontend, Backend, DevOps) per common release-note standards.
 */
export const changelogReleasesData: Omit<
	ChangelogRelease,
	"preview" | "code"
>[] = [
	{
		...
		sections: [
			{
				...
				items: [
					...
					},
					{
						...
						description:
							"Chatwoot widget on the marketing site and dashboard. User identification and logout reset on the dashboard; anonymous widget on the web app.",
					},
				],
			},
			{
				...
				items: [
					{
						...
						description:
							"New release timeline layout with version badges, date columns, tags, categorized sections (Planning → Design → Frontend → Backend → DevOps), and code block previews.",
					},
					{
				...
				items: [
					{
						...
						description:
							"Mailbox and message management UI wired to inbox APIs: list and create mailboxes, list messages, read/unread toggle, and message deletion. Reply, attachments, and other thread actions remain prototype UI.",
					},
					{
						label: "Workflow editor (prototype)",
						description:
							"Visual workflow editor with trigger nodes and empty-state guidance. Workflows persist locally in the browser; automated execution and template triggers are not shipped yet.",
					},
					{
					...
					},
					{
						...
						description:
							"Live chat widget on the marketing site and dashboard. Dashboard syncs the signed-in user to Chatwoot and clears the session on logout; the web app loads the widget without user identification.",
					},
					{
			...
			},
			{
				...
				items: [
					...
					},
					{
						...
						description:
							"KumoMTA inbound JetStream initialization and inbound email subscriber for processing incoming mail into inbox threads.",
					},
					{
					...
					},
					{
						...
						description:
							"Workflow service cleanup with evlog OTLP logging, improved controller logic, standardized import formatting, and refactored routing structure.",
					},
				],
			},
			{
				...
				items: [
					{
						label: "Inbox CI pipeline",
						description:
							"GitHub Actions workflow to build and publish the inbox service Docker image. Updated controller return types and standardized authentication properties.",
					},
					{
				...
				items: [
					{
						...
						description:
							"Typed variables with defaults, triple-brace syntax (e.g., three braces around a variable name), create/edit/delete modals, slash-command insertion in the editor, Valibot + react-hook-form validation.",
					},
					{
			...
			},
			{
				...
				items: [
					...
					},
					{
						...
						description:
							"Node.js API Key service with SDK-based code samples, 201 status for created keys, rate limiting middleware, atomic database operations, session caching, and owner-only key rotation.",
					},
					{
			...
			},
			{
				...
				items: [
					...
					},
					{
						label: "API key CI",
						description:
							"GitHub Actions workflow for building and publishing the API key service Docker image.",
					},
				],
			},
		],
		...
		sections: [
			...
			},
			{
				...
				items: [
					...
					{
						label: "Workflow API routing",
						description:
							"Caddyfile routing and database initialization scripts for the workflow service API.",
					},
				],
			},
			{
				...
				items: [
					{
						...
						description:
							"Mailpit UI routing in Caddyfile, workflow API configuration, and database initialization scripts.",
					},
					{
			...
			},
			{
				...
				items: [
					...
					},
					{
						...
						description:
							"Domain monitoring, DNS verification, health checks, and webhook cleanup jobs handled by the workflow service.",
					},
					{
				...
				items: [
					{
						...
						description:
							"Dockerfiles for core backend services including auth, contacts, domain, webhook, and workflow. VPS deployment setup scripts for production environment.",
					},
					{
						label: "Docker CI workflows",
						description:
							"GitHub Actions workflows for automatic build and push of backend service containers.",
					},
					{
					...
					},
					{
						...
						description:
							"Replaced admin filters with docs filters, standardized backend dev scripts, and Postfix docker compose configuration.",
					},
				],
			},
		],
