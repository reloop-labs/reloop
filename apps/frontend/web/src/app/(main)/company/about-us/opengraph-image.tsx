...
export const alt = "About Us | Reloop";
...
export default function OpenGraphImage() {
		...
		>
			...
			<div style={{ display: "flex", flexDirection: "column", width: "100%" }}>
				...
				<div style={{ display: "flex", flexDirection: "column", marginTop: "24px" }}>
					<span style={{ fontSize: "52px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px" }}>About Us</span>
					<span style={{ fontSize: "18px", color: "rgba(255, 255, 255, 0.5)", marginTop: "10px", maxWidth: "900px" }}>Reloop Labs builds open-source email infrastructure for developers who value autonomy.</span>
				</div>
			</div>
				...
				{([
    {
        ...
        "desc": "Predictable stacks and simple integrations without complexity."
    },
    {
        "title": "Open by Default",
        "desc": "Every line of code is published under Apache 2.0 license."
    },
    {
        "title": "Autonomy & Choice",
        "desc": "Deploy on infrastructure you control, or use Reloop Labs cloud."
    }
]).map((item, idx) => (
					<div
						key={idx}
