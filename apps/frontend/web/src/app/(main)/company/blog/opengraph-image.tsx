...
export default function OpenGraphImage() {
		...
		>
			...
			<div style={{ display: "flex", flexDirection: "column", width: "100%" }}>
				...
				<div style={{ display: "flex", flexDirection: "column", marginTop: "24px" }}>
					<span style={{ fontSize: "52px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px" }}>Blog</span>
					<span style={{ fontSize: "18px", color: "rgba(255, 255, 255, 0.5)", marginTop: "10px", maxWidth: "900px" }}>Technical tutorials, self-hosting guides, architecture deep-dives, and product roadmaps.</span>
				</div>
			</div>
				...
				{([
    {
        ...
        "desc": "Building email platforms in the open and scaling MTAs."
    },
    {
        "title": "Docker Guides",
        "desc": "How to deploy Reloop on VPS and Kubernetes environments."
    },
    {
        "title": "Feature Roadmaps",
        "desc": "Upcoming client SDKs and campaign visual editor releases."
    }
]).map((item, idx) => (
					<div
						key={idx}
