...
export default function OpenGraphImage() {
		...
		>
			...
			<div style={{ display: "flex", flexDirection: "column", width: "100%" }}>
				...
				<div style={{ display: "flex", flexDirection: "column", marginTop: "24px" }}>
					<span style={{ fontSize: "52px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px" }}>Privacy Policy</span>
					<span style={{ fontSize: "18px", color: "rgba(255, 255, 255, 0.5)", marginTop: "10px", maxWidth: "900px" }}>How Reloop Labs handles personal data on reloop.sh and within our hosted email service.</span>
				</div>
			</div>
				...
				{([
    {
        ...
        "desc": "Account data is encrypted both in transit and at rest."
    },
    {
        "title": "Zero Sales of Data",
        "desc": "We never sell, rent, or trade your personal information."
    },
    {
        "title": "Self-Hosted Choice",
        "desc": "Self-hosted deployments process data entirely on your servers."
    }
]).map((item, idx) => (
					<div
						key={idx}
