...
export default function DeveloperSection() {
	return (
		<SectionBlock
			...
			className="bg-[#f8f8f8] dark:bg-[#030303] text-[#0a0d12] dark:text-white border-t border-b border-[#0a0d12]/5 dark:border-white/5"
		>
			{/* Subsection 1: SDK */}
			<FeatureRow
				...
				cards={[
					{
						...
						description: "Fully typed libraries for Node.js, Go, Python, PHP, and Rust.",
					},
					{
						title: "Zero Configuration",
						description: "Get started instantly by importing our client and supplying your API key.",
					},
					{
						title: "React & Next.js Optimized",
						description: "First-class support for Server Components, custom templates, and light/dark modes.",
					},
				]}
				visual={CodeSnippet}
			/>
				...
				cards={[
					{
						...
						description: "We handle the technical complexity of SPF, DKIM, and DMARC so your emails always reach the inbox.",
					},
					{
						title: "AI-powered Content Guard",
						description: "Automatically catch spam triggers, broken images, and phishing signals before sending.",
					},
					{
						title: "Programmable Flow",
						description: "Define complex retry logic, A/B tests, and delivery rules with a simple, YAML-based configuration.",
					},
				]}
				...
				cards={[
					{
						...
						description: "Track send operations and receipt status logs the exact millisecond they occur.",
					},
					{
						title: "Failure Resolution",
						description: "Instantly debug bounce statuses, spam flags, and transient ISP delivery blocks.",
					},
					{
						title: "MTA Latency Metrics",
						description: "Analyze latency curves and pipeline throughput across global node regions.",
					},
				]}
