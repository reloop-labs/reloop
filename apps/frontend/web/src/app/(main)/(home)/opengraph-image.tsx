...
export const alt = "Reloop | Reloop";
...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				<div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
					...
					<span style={{ fontSize: "20px", fontWeight: 500, color: "rgba(255, 255, 255, 0.6)" }}>Platform</span>
				</div>

				<div style={{ display: "flex", flexDirection: "column", gap: "12px", margin: "24px 0" }}>
					<span style={{ fontSize: "48px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px" }}>Reloop</span>
					<span style={{ fontSize: "18px", color: "rgba(255, 255, 255, 0.5)", lineHeight: "1.4" }}>Open-source, self-hostable email infrastructure—hosted by Reloop Labs or deploy it yourself.</span>
				</div>
				...
				{([
    {
        ...
        "desc": "Official packages for TypeScript, Python, Go, and PHP."
    },
    {
        "title": "Developer Sandbox",
        "desc": "Test SMTP & APIs locally without sending real emails."
    },
    {
        "title": "Real-Time MTA Logs",
        "desc": "Trace deliveries, bounces, and latencies down to the millisecond."
    }
]).map((item, idx) => (
					<div
						key={idx}
