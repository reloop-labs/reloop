...
export const alt = "Developers | Reloop";
		...
		>
			...
			>
				...
				<div style={{ display: "flex", flexDirection: "column", width: "100%", marginTop: "24px" }}>
					<div style={{ display: "flex", fontSize: "56px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px", lineHeight: "1.1" }}>Developers</div>
					<div style={{ display: "flex", fontSize: "20px", fontWeight: 400, color: "rgba(255, 255, 255, 0.55)", lineHeight: "1.5", marginTop: "16px" }}>Build premium email operations with clean REST structures, client SDKs, and local test environments.</div>
				</div>
			...
			<div style={{ display: "flex", flexDirection: "column", justifyContent: "center", width: "480px", height: "100%" }}>
				...
				>
					...
					<div style={{ display: "flex", flexDirection: "column", gap: "8px", fontSize: "14px", lineHeight: "1.6" }}>
						{([
    {
        "title": "curl -X POST /v1/send",
        "desc": "Send emails from any CLI shell terminal."
    },
    {
        "title": "reloop-sandbox command",
        "desc": "Spin up a local offline SMTP relay mock."
    },
    {
        "title": "Handshake trace debug",
        "desc": "Trace MTA deliveries down to the millisecond."
    }
]).map((item, idx) => (
