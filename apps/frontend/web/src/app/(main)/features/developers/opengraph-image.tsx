...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				>
					...
					>
						Build premium email operations with clean REST structures, client SDKs, and local test environments.
					</div>
				</div>
    ...
    {
        "title": "Clean APIs",
        "desc": "Predictable REST contract with standardized payload objects."
    },
    {
        "title": "Local Sandbox",
        "desc": "Offline SMTP test servers for pre-production environments."
    },
    {
        "title": "Trace Logs",
        "desc": "Check raw SMTP transcripts and transmission times."
    }
]).map((item, idx) => (
					<div
						key={idx}
