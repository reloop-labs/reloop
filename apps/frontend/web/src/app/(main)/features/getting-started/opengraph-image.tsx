...
export const alt = "Getting Started | Reloop";
...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				<div style={{ display: "flex", flexDirection: "column", width: "100%", marginTop: "24px" }}>
					<div style={{ display: "flex", fontSize: "56px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px", lineHeight: "1.1" }}>Getting Started</div>
					<div style={{ display: "flex", fontSize: "20px", fontWeight: 400, color: "rgba(255, 255, 255, 0.55)", lineHeight: "1.5", marginTop: "16px" }}>Set up your sender domain, create API keys, and transmit your first email in minutes.</div>
				</div>
				...
				{([
    {
        ...
        "desc": "Sign up for a free sandbox account instantly."
    },
    {
        "title": "2. Verify Domain",
        "desc": "Authorize SPF, DKIM, and DMARC DNS settings."
    },
    {
        "title": "3. Transmit",
        "desc": "Transmit test emails via curl, SMTP, or an official SDK."
    }
]).map((item, idx) => (
