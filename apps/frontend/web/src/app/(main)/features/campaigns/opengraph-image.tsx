...
export const alt = "Campaigns | Reloop";
...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				<div style={{ display: "flex", flexDirection: "column", width: "100%", marginTop: "24px" }}>
					<div style={{ display: "flex", fontSize: "56px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px", lineHeight: "1.1" }}>Campaigns</div>
					<div style={{ display: "flex", fontSize: "20px", fontWeight: 400, color: "rgba(255, 255, 255, 0.55)", lineHeight: "1.5", marginTop: "16px" }}>Publish newsletter broadcasts, schedule campaign releases, and track subscriber growth.</div>
				</div>
				...
				{([
    {
        ...
        "desc": "Send large-scale campaigns with reliable queue priority."
    },
    {
        "title": "Scheduled Releases",
        "desc": "Queue and release emails on specific dates and times."
    },
    {
        "title": "Audience Analysis",
        "desc": "Monitor campaign delivery rates, click heatmaps, and unsubscribes."
    }
]).map((item, idx) => (
