...
export const alt = "Features | Reloop";
...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				<div style={{ display: "flex", flexDirection: "column", width: "100%", marginTop: "24px" }}>
					<div style={{ display: "flex", fontSize: "56px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px", lineHeight: "1.1" }}>Features</div>
					<div style={{ display: "flex", fontSize: "20px", fontWeight: 400, color: "rgba(255, 255, 255, 0.55)", lineHeight: "1.5", marginTop: "16px" }}>Explore the full suite of email delivery, building, tracking, and validation capabilities.</div>
				</div>
    ...
    {
        "title": "SMTP & APIs",
        "desc": "Send transactionals and marketing broadcasts in milliseconds."
    },
    {
        "title": "Campaign Builder",
        "desc": "Design beautiful, responsive emails visually or with raw HTML."
    },
    {
        "title": "Real-time Analytics",
        "desc": "Track clicks, opens, and conversions with in-depth reports."
    }
]).map((item, idx) => (
