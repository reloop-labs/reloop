...
export const alt = "Email Validation | Reloop";
...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				<div style={{ display: "flex", flexDirection: "column", width: "100%", marginTop: "24px" }}>
					<div style={{ display: "flex", fontSize: "56px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px", lineHeight: "1.1" }}>Email Validation</div>
					<div style={{ display: "flex", fontSize: "20px", fontWeight: 400, color: "rgba(255, 255, 255, 0.55)", lineHeight: "1.5", marginTop: "16px" }}>Protect your domain sender reputation by validating email addresses before sending.</div>
				</div>
				...
				{([
    {
        ...
        "desc": "Identify and reject malformed addresses at signup."
    },
    {
        "title": "MX Record Lookup",
        "desc": "Verify recipient domain and mail server configuration."
    },
    {
        "title": "Risk Analysis",
        "desc": "Flag disposable, catch-all, and role-based accounts."
    }
]).map((item, idx) => (
