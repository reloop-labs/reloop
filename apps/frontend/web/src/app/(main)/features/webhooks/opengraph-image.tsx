...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				>
					...
					>
						Stream transactional events and delivery logs directly to your backend servers in real time.
					</div>
				</div>
				...
				{([
    {
        ...
        "desc": "Instant payloads for delivery, open, click, and bounce events."
    },
    {
        "title": "HMAC Verification",
        "desc": "Secure webhook validation to verify authentic Reloop payloads."
    },
    {
        "title": "Exponential Backoff",
        "desc": "Automatic retries to protect endpoints from sudden offline states."
    }
]).map((item, idx) => (
					<div
						key={idx}
