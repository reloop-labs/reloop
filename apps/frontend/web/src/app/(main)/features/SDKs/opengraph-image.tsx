...
export const alt = "Official SDKs | Reloop";
		...
		>
			...
			>
				...
				<div style={{ display: "flex", flexDirection: "column", width: "100%", marginTop: "24px" }}>
					<div style={{ display: "flex", fontSize: "56px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px", lineHeight: "1.1" }}>Official SDKs</div>
					<div style={{ display: "flex", fontSize: "20px", fontWeight: 400, color: "rgba(255, 255, 255, 0.55)", lineHeight: "1.5", marginTop: "16px" }}>Type-safe client libraries to integrate email infrastructure into any modern application stack.</div>
				</div>
			...
			<div style={{ display: "flex", flexDirection: "column", justifyContent: "center", width: "480px", height: "100%" }}>
				...
				>
					...
					<div style={{ display: "flex", flexDirection: "column", gap: "8px", fontSize: "14px", lineHeight: "1.6" }}>
						{([
    {
        "title": "npm install reloop-email",
        "desc": "Official Node/TS library."
    },
    {
        "title": "pip install reloop-email",
        "desc": "Sync & async Python client."
    },
    {
        "title": "go get reloop-email",
        "desc": "Idiomatic Go package."
    }
]).map((item, idx) => (
