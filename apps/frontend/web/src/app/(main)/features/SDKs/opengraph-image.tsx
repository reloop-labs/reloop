...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				>
					...
					>
						Type-safe client libraries to integrate email infrastructure into any modern application stack.
					</div>
				</div>
				...
				{([
    {
        ...
        "desc": "Fully typed npm package supporting async operations."
    },
    {
        "title": "Python SDK",
        "desc": "Pydantic-based client for sync and async Python applications."
    },
    {
        "title": "Go SDK",
        "desc": "Idiomatic Go package supporting context propagation."
    }
]).map((item, idx) => (
					<div
						key={idx}
