...
export const alt = "Languages | Reloop";
		...
		>
			...
			>
				...
				<div style={{ display: "flex", flexDirection: "column", width: "100%", marginTop: "24px" }}>
					<div style={{ display: "flex", fontSize: "56px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px", lineHeight: "1.1" }}>Languages</div>
					<div style={{ display: "flex", fontSize: "20px", fontWeight: 400, color: "rgba(255, 255, 255, 0.55)", lineHeight: "1.5", marginTop: "16px" }}>Client libraries and native code examples for Node.js, Python, Go, Rust, PHP, and Java.</div>
				</div>
			...
			<div style={{ display: "flex", flexDirection: "column", justifyContent: "center", width: "480px", height: "100%" }}>
				...
				>
					...
					<div style={{ display: "flex", flexDirection: "column", gap: "8px", fontSize: "14px", lineHeight: "1.6" }}>
						{([
    {
        "title": "reloop.emails.send()",
        "desc": "Unified interface across all packages."
    },
    {
        "title": "Type-Safe payloads",
        "desc": "Fully checked structures for all APIs."
    },
    {
        "title": "Telemetry integrated",
        "desc": "Trace request details automatically."
    }
]).map((item, idx) => (
