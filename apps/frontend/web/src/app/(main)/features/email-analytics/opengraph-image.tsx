...
export const alt = "Email Analytics | Reloop";
...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				<div style={{ display: "flex", flexDirection: "column", width: "100%", marginTop: "24px" }}>
					<div style={{ display: "flex", fontSize: "56px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px", lineHeight: "1.1" }}>Email Analytics</div>
					<div style={{ display: "flex", fontSize: "20px", fontWeight: 400, color: "rgba(255, 255, 255, 0.55)", lineHeight: "1.5", marginTop: "16px" }}>Track open rates, click activity, conversions, and bounce trends down to the recipient.</div>
				</div>
				...
				{([
    {
        ...
        "desc": "Measure engagement with precise click and geographic tracking."
    },
    {
        "title": "Conversion Tracking",
        "desc": "Correlate email activity with sales using UTM parameters."
    },
    {
        "title": "Real-time Dashboards",
        "desc": "Live monitoring of delivery pipelines and delivery rates."
    }
]).map((item, idx) => (
