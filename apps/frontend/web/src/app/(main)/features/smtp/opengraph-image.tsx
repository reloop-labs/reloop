...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				>
					...
					>
						Integrate Reloop into legacy systems, CMS platforms, or applications via standard SMTP relay.
					</div>
				</div>
				...
				{([
    {
        ...
        "desc": "Connect securely on TLS port 587, 2525, or SSL 465."
    },
    {
        "title": "High Throughput",
        "desc": "Built on custom MTA routing for concurrent delivery loops."
    },
    {
        "title": "Detailed Logging",
        "desc": "Full handshake and transmission logging visible in the dashboard."
    }
]).map((item, idx) => (
					<div
						key={idx}
