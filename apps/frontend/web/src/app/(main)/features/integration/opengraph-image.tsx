...
export const alt = "Integrations | Reloop";
...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				<div style={{ display: "flex", flexDirection: "column", width: "100%", marginTop: "24px" }}>
					<div style={{ display: "flex", fontSize: "56px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px", lineHeight: "1.1" }}>Integrations</div>
					<div style={{ display: "flex", fontSize: "20px", fontWeight: 400, color: "rgba(255, 255, 255, 0.55)", lineHeight: "1.5", marginTop: "16px" }}>Connect email infrastructure to your application stack with simple APIs and event webhooks.</div>
				</div>
    ...
    {
        "title": "REST API",
        "desc": "HTTP endpoints with standardized JSON structures."
    },
    {
        "title": "Webhooks Engine",
        "desc": "Push delivery and bounce events directly to your backend."
    },
    {
        "title": "Official SDKs",
        "desc": "Client libraries for Node, Go, Python, PHP, and Rust."
    }
]).map((item, idx) => (
