...
export const alt = "Campaign Builder | Reloop";
...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				<div style={{ display: "flex", flexDirection: "column", width: "100%", marginTop: "24px" }}>
					<div style={{ display: "flex", fontSize: "56px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px", lineHeight: "1.1" }}>Campaign Builder</div>
					<div style={{ display: "flex", fontSize: "20px", fontWeight: 400, color: "rgba(255, 255, 255, 0.55)", lineHeight: "1.5", marginTop: "16px" }}>Compose visually stunning newsletters without writing code using our block editor.</div>
				</div>
				...
				{([
    {
        ...
        "desc": "Arrange text, images, and CTA buttons visually."
    },
    {
        "title": "Responsive Designs",
        "desc": "Auto-optimized layout for mobile, tablet, and web clients."
    },
    {
        "title": "Layout Library",
        "desc": "Save and reuse custom brand block libraries."
    }
]).map((item, idx) => (
