...
export const alt = "AI Agents | Reloop";
...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				<div style={{ display: "flex", flexDirection: "column", width: "100%", marginTop: "24px" }}>
					<div style={{ display: "flex", fontSize: "56px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px", lineHeight: "1.1" }}>AI Agents</div>
					<div style={{ display: "flex", fontSize: "20px", fontWeight: 400, color: "rgba(255, 255, 255, 0.55)", lineHeight: "1.5", marginTop: "16px" }}>Structured email parsing, autonomous inboxes, and webhooks built for AI-driven workflows.</div>
				</div>
    ...
    {
        "title": "Agent Inboxes",
        "desc": "Dedicated inbox endpoints for autonomous agent systems."
    },
    {
        "title": "Structured Parsing",
        "desc": "Extract semantic metadata and keys from unstructured text."
    },
    {
        "title": "Automation Loop",
        "desc": "Trigger custom agent flows based on inbound email events."
    }
]).map((item, idx) => (
