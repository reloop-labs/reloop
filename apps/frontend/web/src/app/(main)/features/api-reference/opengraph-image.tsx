...
export const alt = "API Reference | Reloop";
...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				<div style={{ display: "flex", flexDirection: "column", width: "100%", marginTop: "24px" }}>
					<div style={{ display: "flex", fontSize: "56px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px", lineHeight: "1.1" }}>API Reference</div>
					<div style={{ display: "flex", fontSize: "20px", fontWeight: 400, color: "rgba(255, 255, 255, 0.55)", lineHeight: "1.5", marginTop: "16px" }}>Send emails, manage subscriber lists, and fetch deliverability logs via clean developer APIs.</div>
				</div>
    ...
    {
        "title": "POST /v1/send",
        "desc": "Transmit transactional or campaign emails."
    },
    {
        "title": "GET /v1/contacts",
        "desc": "Query audiences, lists, and subscriber metadata."
    },
    {
        "title": "GET /v1/events",
        "desc": "Query delivery, click, and bounce history logs."
    }
]).map((item, idx) => (
