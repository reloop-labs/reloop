...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				>
					...
					>
						Send emails, manage subscriber lists, and fetch deliverability logs via clean developer APIs.
					</div>
				</div>
    ...
    {
        "title": "POST /v1/send",
        "desc": "Submit transactional or campaign emails with simple payloads."
    },
    {
        "title": "GET /v1/contacts",
        "desc": "Manage audiences, lists, and subscriber metadata."
    },
    {
        "title": "GET /v1/events",
        "desc": "Query detailed delivery, click, and bounce history logs."
    }
]).map((item, idx) => (
					<div
						key={idx}
