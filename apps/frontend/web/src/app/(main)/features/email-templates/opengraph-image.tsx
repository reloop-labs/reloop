...
export const alt = "Email Templates | Reloop";
...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				<div style={{ display: "flex", flexDirection: "column", width: "100%", marginTop: "24px" }}>
					<div style={{ display: "flex", fontSize: "56px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px", lineHeight: "1.1" }}>Email Templates</div>
					<div style={{ display: "flex", fontSize: "20px", fontWeight: 400, color: "rgba(255, 255, 255, 0.55)", lineHeight: "1.5", marginTop: "16px" }}>Manage reusable email layouts and personalize them dynamically using simple JSON variables.</div>
				</div>
				...
				{([
    {
        ...
        "desc": "Design layouts using modular drag-and-drop components."
    },
    {
        "title": "Raw HTML Editor",
        "desc": "Import custom code and edit templates with syntax highlighting."
    },
    {
        "title": "Merge Tags",
        "desc": "Inject customer details dynamically at delivery time."
    }
]).map((item, idx) => (
