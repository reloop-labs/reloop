...
export const alt = "Deliverability | Reloop";
...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				<div style={{ display: "flex", flexDirection: "column", width: "100%", marginTop: "24px" }}>
					<div style={{ display: "flex", fontSize: "56px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px", lineHeight: "1.1" }}>Deliverability</div>
					<div style={{ display: "flex", fontSize: "20px", fontWeight: 400, color: "rgba(255, 255, 255, 0.55)", lineHeight: "1.5", marginTop: "16px" }}>Maintain a stellar sender reputation and guarantee your emails reach the primary inbox.</div>
				</div>
    ...
    {
        "title": "Spam Testing",
        "desc": "Run pre-send checks against major email providers' filters."
    },
    {
        "title": "DNS Setup Guide",
        "desc": "Guided instructions to authorize SPF, DKIM, and DMARC keys."
    },
    {
        "title": "Reputation Tracking",
        "desc": "Proactive monitoring of IP blacklists and sender scores."
    }
]).map((item, idx) => (
