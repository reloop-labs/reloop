...
export default function OpenGraphImage() {
		...
		>
			...
			<div style={{ display: "flex", flexDirection: "column", width: "100%" }}>
				...
				<div style={{ display: "flex", flexDirection: "column", marginTop: "24px" }}>
					<span style={{ fontSize: "52px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px" }}>Why Open Source</span>
					<span style={{ fontSize: "18px", color: "rgba(255, 255, 255, 0.5)", marginTop: "10px", maxWidth: "900px" }}>Why we chose Apache 2.0 open-source licensing for our core email infrastructure codebase.</span>
				</div>
			</div>
    ...
    {
        "title": "Zero Lock-In",
        "desc": "Migrate your database and deployment setups at any time."
    },
    {
        "title": "Security Auditing",
        "desc": "Visibility enables community code audits and patches."
    },
    {
        "title": "Collaborative Growth",
        "desc": "Contributions from developers shape the future roadmap."
    }
]).map((item, idx) => (
					<div
						key={idx}
