...
export const alt = "Our Product Beliefs | Reloop";
...
export default function OpenGraphImage() {
		...
		>
			...
			<div style={{ display: "flex", flexDirection: "column", width: "100%" }}>
				...
				<div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
					...
					<span style={{ fontSize: "22px", fontWeight: 500, color: "rgba(255, 255, 255, 0.6)", letterSpacing: "-0.5px", marginLeft: "8px" }}>Philosophy</span>
				</div>

				<div style={{ display: "flex", flexDirection: "column", marginTop: "24px" }}>
					<span style={{ fontSize: "52px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px" }}>Our Product Beliefs</span>
					<span style={{ fontSize: "18px", color: "rgba(255, 255, 255, 0.5)", marginTop: "10px", maxWidth: "900px" }}>How we approach product decisions: developer-first features, deployment choice, and pricing parity.</span>
				</div>
			</div>
				...
				{([
    {
        ...
        "desc": "We build features for programmers, not enterprise salespeople."
    },
    {
        "title": "Autonomy",
        "desc": "Providing the choice to host yourself or use our cloud platform."
    },
    {
        "title": "Licensing Parity",
        "desc": "Hosted features run on the exact same open-source codebase."
    }
]).map((item, idx) => (
					<div
						key={idx}
