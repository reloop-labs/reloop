...
export default function Hero() {
	return (
		<section className="relative flex min-h-[85vh] items-center justify-center overflow-hidden bg-[#05070b] py-24 text-white sm:py-32">
			...
			<div className="-translate-x-1/2 pointer-events-none absolute top-0 left-1/2 h-[500px] w-[800px] rounded-full bg-purple-600/5 blur-[120px]" />
			...
			<div className="relative z-10 mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
				...
				<p className="mx-auto mt-8 max-w-[620px] text-[15px] text-white/50 leading-relaxed sm:text-[17px]">
					...
					Enable your AI workforce to safely read, write, parse, and act on
					email workflows in real time.
				</p>
