...
export default function OpenGraphImage() {
		...
		>
			...
			>
				...
				>
					...
					>
						Have questions about Reloop? Reach out via Discord, GitHub, or direct email.
					</div>
				</div>
				...
				{([
    {
        ...
        "desc": "Join the live developer chat for real-time support."
    },
    {
        "title": "GitHub Repository",
        "desc": "Report issues, submit PRs, and explore our open source codebase."
    },
    {
        "title": "Email Support",
        "desc": "Direct assistance from the creators of the platform."
    }
]).map((item, idx) => (
					<div
						key={idx}
