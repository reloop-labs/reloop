...
export default function OpenGraphImage() {
		...
		>
			...
			<div style={{ display: "flex", flexDirection: "column", width: "100%" }}>
				...
				<div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
					...
					<span style={{ fontSize: "22px", fontWeight: 500, color: "rgba(255, 255, 255, 0.6)", letterSpacing: "-0.5px", marginLeft: "8px" }}>Contact</span>
				</div>

				<div style={{ display: "flex", flexDirection: "column", marginTop: "24px" }}>
					<span style={{ fontSize: "52px", fontWeight: 700, color: "#ffffff", letterSpacing: "-1.5px" }}>Contact</span>
					<span style={{ fontSize: "18px", color: "rgba(255, 255, 255, 0.5)", marginTop: "10px", maxWidth: "900px" }}>Have questions about Reloop? Reach out via Discord, GitHub, or direct email.</span>
				</div>
			</div>
				...
				{([
    {
        ...
        "desc": "Live chat channels with team developers and contributors."
    },
    {
        "title": "GitHub Issues",
        "desc": "Open bugs, request features, and track pull requests."
    },
    {
        "title": "Direct Email",
        "desc": "Reach out directly for account, billing, or security queries."
    }
]).map((item, idx) => (
					<div
						key={idx}
