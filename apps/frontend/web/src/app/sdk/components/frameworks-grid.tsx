					...
					{frameworks.map((fw) => {
						...
						return (
							<Link
								...
								className="group flex flex-col items-start gap-2 bg-white p-4 transition-colors duration-200 hover:bg-[#f7f7f7] sm:p-5 dark:bg-black dark:hover:bg-gray-900"
							>
