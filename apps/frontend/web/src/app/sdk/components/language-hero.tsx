...
import { buildLanguagePrompt } from "../build-language-prompt";
...
export default function LanguageHero({
	...
	const prompt = buildLanguagePrompt(language);
					...
					<div className="relative z-10 flex items-start gap-4 sm:gap-5">
						<div
							className={cn(
								...
								isDarkBrandColor(language.icon.hex) &&
									"text-text-strong-950 dark:text-white",
							)}
							style={getBrandColorStyle(language.icon.hex)}
						>
							<LanguageIcon
								icon={language.icon}
