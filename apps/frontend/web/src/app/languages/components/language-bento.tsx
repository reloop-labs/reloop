			...
			<div className="mx-auto max-w-[1320px] px-4 sm:px-6 lg:px-8">
				<div className="flex flex-col gap-2">
					...
					<p className="max-w-2xl text-base text-text-sub-600 leading-relaxed dark:text-white/60">
						Designed from the ground up for high concurrency, zero memory leaks,
						and seamless developer experience in production.
					</p>
				</div>
				...
				<div className="mt-10 grid gap-px overflow-hidden rounded-xl border border-stroke-soft-200 bg-stroke-soft-200 sm:grid-cols-2 lg:grid-cols-3 dark:border-white/10 dark:bg-white/10">
					...
					<div className="flex flex-col justify-between bg-bg-white-0 p-6 sm:col-span-2 dark:bg-bg-black-950">
						<div>
							<span className="font-mono text-text-sub-600 text-xs uppercase tracking-wider dark:text-white/40">
								Idiomatic Design
							</span>
							<h3 className="mt-2 font-semibold text-lg text-text-strong-950 dark:text-white">
								Native {language.name} Client Patterns
							</h3>
							<p className="mt-2 max-w-lg text-text-sub-600 text-xs leading-relaxed dark:text-white/60">
								Respects established conventions—predictable exception classes,
								strict typing, and full support for {language.primaryFramework}.
							</p>
						</div>
					...
					<div className="flex flex-col justify-between bg-bg-white-0 p-6 dark:bg-bg-black-950">
						<div>
							...
							<p className="mt-2 text-text-sub-600 text-xs leading-relaxed dark:text-white/60">
								HTTP requests route directly through Reloop edge proxies using
					...
					<div className="flex flex-col justify-between bg-bg-white-0 p-6 dark:bg-bg-black-950">
						<div>
							...
							<p className="mt-2 text-text-sub-600 text-xs leading-relaxed dark:text-white/60">
								Cryptographically verify incoming delivery, bounce, and open
								webhooks inside your {language.name} handlers.
							</p>
						</div>
						<div className="mt-6 border-stroke-soft-200 border-t pt-3 dark:border-white/10">
							<span className="font-mono text-[11px] text-text-sub-600 dark:text-white/50">
					...
					<div className="flex flex-col justify-between bg-bg-white-0 p-6 sm:col-span-2 dark:bg-bg-black-950">
						<div>
							...
							<p className="mt-2 max-w-lg text-text-sub-600 text-xs leading-relaxed dark:text-white/60">
								Includes domain verification helpers, rate-limit state
								inspections, request IDs, and structured logging hooks.
							</p>
						</div>
