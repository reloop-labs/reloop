...
export default function LanguageGuide({
	...
	return (
		<section
			id="guide"
			className="w-full border-stroke-soft-200 border-t bg-bg-weak-50/40 py-16 sm:py-20 lg:py-24 dark:border-white/10 dark:bg-white/[0.01]"
		>
			<div className="mx-auto max-w-[1320px] px-4 sm:px-6 lg:px-8">
				...
				<div className="mt-10 grid gap-px overflow-hidden rounded-xl border border-stroke-soft-200 bg-stroke-soft-200 md:grid-cols-3 dark:border-white/10 dark:bg-white/10">
					...
					<div className="flex flex-col justify-between bg-bg-white-0 p-6 dark:bg-bg-black-950">
						<div>
							<span className="font-mono font-semibold text-text-sub-600 text-xs dark:text-white/40">
								STEP 01
							</span>
							...
							<div className="mt-4 rounded-lg border border-stroke-soft-200 bg-bg-weak-50 px-3 py-2 font-mono text-text-strong-950 text-xs dark:border-white/10 dark:bg-white/5 dark:text-white">
					...
					<div className="flex flex-col justify-between bg-bg-white-0 p-6 dark:bg-bg-black-950">
						<div>
							...
							<p className="mt-2 text-text-sub-600 text-xs leading-relaxed dark:text-white/60">
								Export your secret key from the Reloop dashboard into your
								environment:
							</p>
							<div className="mt-4 rounded-lg border border-stroke-soft-200 bg-bg-weak-50 px-3 py-2 font-mono text-text-strong-950 text-xs dark:border-white/10 dark:bg-white/5 dark:text-white">
								RELOOP_API_KEY="re_..."
					...
					<div className="flex flex-col justify-between bg-bg-white-0 p-6 dark:bg-bg-black-950">
						<div>
							...
							<p className="mt-2 text-text-sub-600 text-xs leading-relaxed dark:text-white/60">
								Call the SDK send method with HTML content and recipient
								address.
							</p>
							<div className="mt-4">
								<Link
