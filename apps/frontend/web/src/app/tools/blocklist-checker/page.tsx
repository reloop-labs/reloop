...
export default function BlocklistCheckerPage() {
	...
	return (
		<>
			...
			<Band id="api">
				<SectionIntro
					lead="Validate blocklists via code."
					description={`POST an IP or domain name to the public tools endpoint. It queries the same ${publicBlocklistCount} DNS blocklists as this page.`}
				/>
			...
			<Band id="faq">
				<SectionIntro
					...
					description="Answers to common questions regarding DNS blocklists, domain URI lookups, and deliverability reputation."
				/>
