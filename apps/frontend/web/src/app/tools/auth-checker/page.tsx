	...
	return (
		<>
				...
				data={[
					{
						...
						featureList: [
							"SPF lookup & RFC 7208 10 lookup limit verification",
							"DKIM selector public key & RSA bit strength validation",
							"DMARC policy enforcement & aggregate reporting check",
							"MX routing server reachability & priority audit",
			...
			<Band id="why-it-matters">
				<SectionIntro
					lead="Why sender authentication matters."
					description="Protect your domain reputation and ensure your transactional and marketing emails land directly in inboxes instead of spam folders."
				/>
			...
			<Band id="api">
				<SectionIntro
					lead="Audit authentication records programmatically."
					description="Integrate automated SPF, DKIM, and DMARC verification into your onboarding flow with our zero-setup public API."
				/>
			...
			<Band id="faq">
				<SectionIntro
					...
					description="Everything you need to know about SPF lookup limits, DKIM selectors, DMARC policies, and mail deliverability standards."
				/>
