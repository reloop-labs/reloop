...
export default function DeliverabilityTesterPage() {
	...
	return (
		<>
				...
				data={[
					{
						...
						featureList: [
							...
							"Public unauthenticated REST API with JSON response",
						],
						publisher: {
							"@type": "Organization",
							name: "Reloop",
			...
			{/* Section: Why Deliverability Testing Matters */}
			<Band id="why-it-matters">
				<SectionIntro
					lead="Comprehensive deliverability diagnostics."
			...
			<Band id="api">
				<SectionIntro
					lead="Automate deliverability checks via API."
					description="Integrate automated spam scoring into your CI/CD pipelines, staging environments, or internal email review workflows."
				/>
			...
			<Band id="faq">
				<SectionIntro
					...
					description="Everything you need to know about technical deliverability, score calculation, privacy, and mail-tester parity."
				/>
