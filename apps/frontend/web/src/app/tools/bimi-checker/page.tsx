	...
	return (
		<>
			...
			<Band id="why-it-matters">
				<SectionIntro
					lead="What this lookup actually checks."
					description="BIMI is a DNS assertion plus a logo file. Supporting inboxes still require DMARC at enforcement."
				/>
			...
			<Band id="faq">
				<SectionIntro
					...
					description="BIMI records, DMARC enforcement, SVG Tiny PS, and Verified Mark Certificates."
				/>
