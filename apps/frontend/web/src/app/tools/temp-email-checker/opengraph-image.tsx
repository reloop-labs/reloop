				...
				{[
					{
						...
						desc: "Match against known throwaway mailbox providers.",
					},
					{
						title: "Wildcard Patterns",
						desc: "Catch whole subdomain families, not one host at a time.",
					},
					{
						title: "Free & Role Signals",
						desc: "Separate consumer mailboxes from shared team inboxes.",
					},
				].map((item, idx) => (
					<div
						key={idx}
