...
export function TempEmailHero() {
	return (
		<div className="relative w-full overflow-hidden">
			{/* Hero Header */}
			<header className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center px-6 pt-28 pb-8 text-center sm:px-8 sm:pt-32 sm:pb-10 md:max-w-7xl lg:px-12 lg:pt-36 lg:pb-12">
