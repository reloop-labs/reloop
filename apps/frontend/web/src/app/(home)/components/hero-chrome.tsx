...
export function HeroWindowChrome({
	...
	return (
		<div className="relative flex min-h-0 flex-1 flex-col overflow-hidden rounded-[20px] border border-stroke-soft-100 bg-bg-weak-50 p-[7px] pt-8 sm:rounded-[24px] sm:p-2 sm:pt-9 dark:border-white/10 dark:bg-white/[0.06]">
			<div
				aria-hidden
			...
			<div className="relative min-h-0 flex-1 overflow-hidden rounded-[13px] border border-stroke-soft-100 bg-bg-white-0 sm:rounded-[16px] dark:border-white/10 dark:bg-black">
				{children}
			</div>
		</div>
	);
