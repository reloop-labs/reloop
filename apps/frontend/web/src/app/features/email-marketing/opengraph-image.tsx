...
export const alt = "Email Marketing | Reloop";
		...
		>
			...
			>
				...
				>
					...
					>
						Send newsletters, launches, and drip campaigns at scale.
					</div>
				</div>
				...
				{[
					{
						...
						desc: "Send newsletters and launches to segments in one API call.",
					},
					{
						title: "Automation & Drips",
						desc: "Trigger nurture sequences from signup and lifecycle events.",
					},
					{
						title: "Segments & Analytics",
						desc: "Target engaged contacts and measure opens, clicks, revenue.",
					},
				].map((item, idx) => (
					<div
						key={idx}
