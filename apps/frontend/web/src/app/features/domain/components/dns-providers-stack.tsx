...
const dnsProviders: Integration[] = [
	{
		label: "Cloudflare",
...
export function DnsProvidersStack() {
	return (
		<SectionFrame id="dns-providers" framed={false} showTopRule={false}>
			...
			<AlignedIconBand>
				<div className="grid grid-cols-3 gap-px bg-stroke-soft-200 sm:grid-cols-4 lg:grid-cols-7 dark:bg-white/10">
