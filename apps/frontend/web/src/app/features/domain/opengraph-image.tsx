...
export const alt = "Domain Authentication | Reloop";
				...
				{[
					{
						...
						desc: "Auto-generated cryptographic signing keys with automatic rotation.",
					},
					{
						title: "SPF Alignment",
						desc: "Custom return-path configuration to eliminate spam score penalties.",
					},
					{
						title: "DMARC Enforcement",
						desc: "Live policy monitoring from p=none up to strict p=reject quarantine.",
					},
				].map((item, idx) => (
					<div
						key={idx}
