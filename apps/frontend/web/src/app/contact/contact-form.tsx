...
function ContactChatPanel() {
	...
	if (!mounted || isPending) {
		return (
			<div className="h-[min(320px,calc(100dvh-16rem))] min-h-[240px] w-full animate-pulse rounded-2xl border border-stroke-soft-200 bg-bg-weak-50 dark:border-white/[0.08] dark:bg-[#161616]" />
		);
	}

	return session ? <LoggedInSupport /> : <LoginPrompt />;
}
