...
export function CareersContact() {
	return (
		<section className="w-full border-stroke-soft-200 border-t bg-bg-white-0 text-text-strong-950 dark:border-white/10 dark:bg-black dark:text-white">
			<div className="mx-auto w-full max-w-5xl border-stroke-soft-200 border-x px-6 py-16 text-center sm:px-10 sm:py-20 md:max-w-7xl lg:px-12 lg:py-24 dark:border-white/10">
