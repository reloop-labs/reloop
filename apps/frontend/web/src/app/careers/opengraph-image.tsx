...
export const alt = "Careers at Reloop | Open Source Email Infrastructure";
		...
		>
			<div style={{ display: "flex", flexDirection: "column", width: "100%" }}>
				...
				>
					...
					>
						Open-source email infrastructure for people who care about craft.
					</span>
				</div>
			</div>
				...
				{[
					{
						...
						desc: "We hire for how you think and ship, not your resume.",
					},
					{
						title: "Open source first",
						desc: "Build email infrastructure developers can read and self-host.",
					},
					{
						title: "High bar, no rush",
						desc: "We take time to find people who raise the bar.",
					},
				].map((item, idx) => (
					<div
						key={idx}
