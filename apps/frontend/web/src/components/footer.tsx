...
export const Footer = () => {
	return (
		<footer className="overflow-hidden border-stroke-soft-100 border-t">
			<div className="mx-auto border-stroke-soft-100 border-b">
				<div className="mx-auto flex max-w-7xl flex-col items-start gap-5 border-stroke-soft-100 border-r border-l">
