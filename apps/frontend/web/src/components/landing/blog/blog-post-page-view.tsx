...
export function BlogPostPageView({
	...
	return (
		<div className="min-h-dvh bg-white dark:bg-black">
			{/* Individual Blog Post Article Section */}
			<div className="mx-auto w-full max-w-5xl border-stroke-soft-200 border-x px-6 pt-32 pb-16 md:px-10 dark:border-white/10">
				<div className="relative mx-auto w-full max-w-[720px] pb-8">
					{showToc ? (
