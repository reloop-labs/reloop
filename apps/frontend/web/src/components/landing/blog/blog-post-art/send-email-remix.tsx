...
export function SendEmailRemixArt(_props: BlogPostArtProps) {
	return (
		<>
			<path d="M 188 248 L 300 128 L 412 248 Z" fill="none" stroke="currentColor" strokeOpacity={0.18} />
			...
			<line x1={268} y1={296} x2={332} y2={296} stroke="currentColor" strokeOpacity={0.12} />
		</>
	);
}
