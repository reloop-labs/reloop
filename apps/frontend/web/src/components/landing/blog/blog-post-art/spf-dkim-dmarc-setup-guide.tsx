...
export function SpfDkimDmarcSetupGuideArt(_props: BlogPostArtProps) {
	return (
		<>
			...
			<text x={180} y={192} className="fill-current font-mono text-[10px] opacity-30 dark:opacity-50" textAnchor="middle">SPF</text>
			<text x={276} y={192} className="fill-current font-mono text-[10px] opacity-30 dark:opacity-50" textAnchor="middle">DKIM</text>
			<text x={372} y={192} className="fill-current font-mono text-[10px] opacity-30 dark:opacity-50" textAnchor="middle">DMARC</text>
		</>
	);
}
