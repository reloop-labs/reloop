...
export function ReloopFlyioDeploymentArt(_props: BlogPostArtProps) {
	return (
		<>
			<circle cx={220} cy={188} r={28} fill="none" stroke="currentColor" strokeOpacity={0.18} />
			<circle cx={300} cy={156} r={28} fill="none" stroke="currentColor" strokeOpacity={0.18} />
			<circle cx={380} cy={188} r={28} fill="none" stroke="currentColor" strokeOpacity={0.22} accent />
