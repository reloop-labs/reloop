...
export const WorkflowNotFound = () => {
	...
	return (
		<div className="mx-auto flex h-full max-w-md flex-col items-center justify-center px-8 py-24 text-center">
			...
			<p className="mb-6 text-sm text-text-sub-600">
				This automation may have been deleted or the link is incorrect.
			</p>
