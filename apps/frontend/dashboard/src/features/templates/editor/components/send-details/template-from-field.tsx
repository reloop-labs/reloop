...
export const TemplateFromField = () => {
	...
	const getDisplayValue = () => {
		if (senderName && fromEmail && !fromEmail.includes("<")) {
			return `${senderName} <${fromEmail}>`;
		}
		return fromEmail || senderName || "";
	};
	...
	}, [senderName, fromEmail, isDropdownOpen]);
		...
		<>
			...
			<AnimatePresence initial={false}>
				{showReplyTo && (
					...
					>
						<TemplateFieldRow
							id="template-send-details-reply-to"
							label="Reply-To"
							infoTooltip={{
