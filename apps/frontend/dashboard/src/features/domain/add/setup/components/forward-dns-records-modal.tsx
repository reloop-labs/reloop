...
export const ForwardDNSRecordsModal = ({
	...
	return (
		<Modal.Root open={open} onOpenChange={onOpenChange}>
			<Modal.Content className="w-[400px] max-w-[90vw] p-5">
				<motion.div layout transition={shouldReduceMotion ? { duration: 0 } : layoutSpringConfig}>
							...
							>
								<div className="space-y-1 text-left">
									...
									<Modal.Description className="text-text-sub-600 text-xs leading-relaxed">
										...
										administrator — they'll get everything needed to complete
										setup.
									</Modal.Description>
								</div>
