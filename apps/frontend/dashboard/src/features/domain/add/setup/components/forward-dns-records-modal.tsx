...
export const ForwardDNSRecordsModal = ({
	...
	return (
		<Modal.Root open={open} onOpenChange={onOpenChange}>
			<Modal.Content className="w-[400px] max-w-[90vw] p-6">
				<AnimatePresence mode="wait">
					{isSent ? (
						...
						>
							...
							<h3 className="mt-3 font-semibold text-base text-text-strong-950">
								Instructions Sent!
							</h3>
							<p className="mt-1 text-text-sub-600 text-xs leading-relaxed">
								Setup instructions have been sent to{" "}
						...
						>
							<div className="space-y-1 text-left">
								<Modal.Title className="font-semibold text-title-h6 text-text-strong-950">
									Forward DNS records
								</Modal.Title>
