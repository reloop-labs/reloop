				...
				<div className="mt-0.5 flex flex-col gap-1.5">
					{provider?.url ? (
						<a
							...
							className="group flex cursor-pointer items-center gap-1.5 text-sm text-text-strong-950 transition-opacity hover:opacity-80"
						>
							{dnsIcon && (
								<span
							...
							<span className="flex items-center gap-px">
								<span className="font-medium text-paragraph-sm underline decoration-stroke-soft-200 decoration-dashed underline-offset-4 transition-colors group-hover:decoration-primary-base">
									{provider.label}
								</span>
								<Icon
									name="arrow-up-right"
									className="h-3 w-3 text-text-soft-400 transition-colors group-hover:text-primary-base"
								/>
							</span>
						</a>
					) : provider ? (
