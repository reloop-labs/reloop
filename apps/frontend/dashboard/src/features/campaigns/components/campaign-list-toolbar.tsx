...
import { CampaignStatusFilterChip } from "../filters/status-filter-chip";
import type { CampaignViewColumnId } from "../hooks/use-campaign-column-visibility";
import { CampaignViewPopover } from "./campaign-view-popover";

const SEARCH_INPUT_ID = "campaign-list-search";
...
export function CampaignListToolbar({
	...
	const { isRefreshing, refresh } = useToolbarRefresh(invalidate);
							...
							<div className="flex items-start gap-2.5">
								...
								<div className="min-w-0 flex-1">
									...
									<p className="mt-0.5 text-paragraph-xs text-text-sub-600">
										{isRefreshing
											? "Fetching the latest campaigns."
											: "Reload campaigns from the server."}
									</p>
								</div>
							</div>
						</Tooltip.Content>
