					...
					<DigitInput.Group className="w-full justify-between gap-1.5 sm:justify-center sm:gap-2.5">
						{[0, 1, 2, 3, 4, 5].map((index) => (
							<DigitInput.Slot
								key={index}
								index={index}
								className="size-11 shrink rounded-xl border-stroke-soft-200 bg-bg-white-0 text-base transition-colors duration-200 data-[active=true]:border-primary-base data-[success=true]:border-success-base! data-[success=true]:bg-success-lighter! data-[success=true]:text-success-base! data-[active=true]:ring-primary-base/30 data-[success=true]:ring-0! sm:size-12 sm:text-lg md:size-13"
							/>
						))}
					</DigitInput.Group>
				</DigitInput.Root>
