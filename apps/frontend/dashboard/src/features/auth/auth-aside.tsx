	...
	return (
		...
		>
			<div className="flex w-full max-w-md flex-col items-center gap-6">
				<div className="w-full rounded-2xl border border-stroke-soft-200 bg-bg-white-0 p-5 shadow-sm dark:border-stroke-soft-100/40 dark:bg-[#0c0c0c]">
				...
				<div className="flex w-full flex-col gap-3 pl-6">
					<div className="h-10 w-full rounded-full border border-stroke-soft-200 border-dashed bg-bg-white-0/60 dark:border-stroke-soft-100/40" />
					<div className="h-10 w-full rounded-full border border-stroke-soft-200 border-dashed bg-bg-white-0/60 dark:border-stroke-soft-100/40" />
					<div className="h-10 w-full rounded-full border border-stroke-soft-200 border-dashed bg-bg-white-0/60 dark:border-stroke-soft-100/40" />
				</div>
			</div>
