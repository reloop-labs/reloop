		...
		<div className="mx-auto max-w-3xl space-y-8 p-6 lg:p-8">
			...
			<div className="w-full text-paragraph-sm">
				...
				<div
					className={cn(
						gridClass,
						"rounded-t-[14px] border-stroke-soft-100 border-t border-r border-l bg-bg-weak-50/50 pt-2.5 pb-5 font-medium text-text-sub-600 dark:bg-bg-weak-50/40",
					)}
				>
				...
				{/* Table Body */}
				<div className="-mt-2.5 mb-16 divide-y divide-stroke-soft-100 overflow-hidden rounded-xl border border-stroke-soft-100 bg-bg-white-0 dark:divide-stroke-soft-100/50 dark:border-stroke-soft-100/50">
					{isLoadingMailboxes ? (
						[1, 2, 3].map((i) => (
							<div
								key={i}
							...
							>
								<div className="flex items-center gap-2">
									<div className="h-4 w-4 shrink-0 rounded bg-bg-weak-50" />
						...
						mailboxes.map((mailbox) => {
							...
							return (
								<div
									key={mailbox.id}
									onClick={() => void navigate({ to: "/inbox/$mailboxId", params: { mailboxId: mailbox.id } })}
									className={cn(
										gridClass,
								...
								>
									...
									{/* Actions */}
									<div
										className="flex items-center justify-center text-text-sub-600"
										onClick={(e) => e.stopPropagation()}
									>
