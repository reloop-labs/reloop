...
export function SidebarPreview({ name, logo }: SidebarPreviewProps) {
	...
	return (
		<div className="absolute top-28 left-16">
			<div className="relative flex h-[500px] w-[560px] flex-col overflow-hidden rounded-2xl border border-stroke-soft-100 bg-bg-white-0 shadow-2xl dark:border-stroke-soft-100/40">
				{/* Mac Window Header */}
				<div className="flex items-center gap-2 border-stroke-soft-100 border-b bg-bg-white-0 px-4 py-3 dark:border-stroke-soft-100/40">
