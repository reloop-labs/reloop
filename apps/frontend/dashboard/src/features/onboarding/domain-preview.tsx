			...
			<div
				className={
					isDomainVariant
						...
						: "relative flex h-[520px] w-full max-w-[600px] flex-col overflow-hidden rounded-2xl border border-stroke-soft-100 bg-bg-white-0 dark:border-stroke-soft-100/40"
				}
						...
						<div className="relative z-10 min-w-0 flex-1">
							...
							<div className="relative mt-2">
								<div
									className={
										isDomainVariant
											? "relative rounded-lg border border-stroke-soft-100 bg-bg-white-0 p-3 text-text-sub-600 text-xs leading-relaxed dark:border-stroke-soft-100/40"
											: "relative rounded-lg border border-stroke-soft-100 bg-bg-white-0 p-4 text-text-sub-600 text-xs leading-relaxed dark:border-stroke-soft-100/40"
									}
								>
