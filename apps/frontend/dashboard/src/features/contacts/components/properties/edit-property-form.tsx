			...
			>
				<div
					className={cn(
						"space-y-4",
						isInline
							? "m-0.5 rounded-2xl border border-stroke-soft-200 bg-bg-white-0 px-6 pt-5 pb-6 dark:border-stroke-soft-100/40 dark:bg-[#0c0c0c]"
							: "relative m-0.5 space-y-4 rounded-2xl border border-stroke-soft-200 bg-bg-white-0 pt-5 dark:border-stroke-soft-100/40 dark:bg-[#0c0c0c]",
					)}
				>
					{/* Modal Header */}
					{!isInline && (
					...
					<div className={cn(isInline ? "space-y-4" : "space-y-4 px-6 pb-6")}>
						...
						<div className="space-y-1.5">
							<div className="flex items-center gap-2">
								<Label.Root
									htmlFor={`fallback-value-${property.id}`}
									className="font-medium text-text-strong-950 text-xs"
								>
									Default Value
								</Label.Root>
