...
import { PropertyTypeFilterChip } from "../../filters/type-filter-chip";
import { useInvalidateContacts } from "../../hooks/use-contacts-query";
import type { PropertyViewColumnId } from "../../hooks/use-property-column-visibility";
import { PropertyViewPopover } from "./property-view-popover";

const REFRESH_SPIN_MS = 2000;
const SEARCH_INPUT_ID = "property-list-search";
							...
							<div className="flex items-start gap-2.5">
								...
								<div className="min-w-0 flex-1">
									...
									<p className="mt-0.5 text-paragraph-xs text-text-sub-600">
										{isRefreshing
											? "Fetching the latest properties."
											: "Reload properties from the server."}
									</p>
								</div>
							</div>
						</Tooltip.Content>
