	...
	return (
		<div className="w-full text-paragraph-sm">
			<div className="overflow-hidden rounded-[18px] border border-stroke-soft-200 bg-bg-soft-50 dark:border-stroke-soft-100/40 dark:bg-bg-weak-50/40">
				{/* Table Header */}
				<div className="grid grid-cols-[1fr_100px_150px_80px] items-center px-4 pt-3 pb-2.5 font-medium text-text-sub-600 dark:text-text-sub-600">
				...
				<div className="m-0.5 divide-y divide-stroke-soft-100 overflow-hidden rounded-2xl border border-stroke-soft-200 bg-bg-white-0 dark:divide-stroke-soft-100/50 dark:border-stroke-soft-100/40 dark:bg-bg-white-0">
					{isLoading ? (
