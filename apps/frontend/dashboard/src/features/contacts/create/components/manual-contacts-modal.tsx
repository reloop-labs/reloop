...
interface ManualContactsModalProps {
	open: boolean;
...
export function ManualContactsModal({
	open,
	onOpenChange,
	onSuccess,
}: ManualContactsModalProps) {
				...
				await Promise.all(
					batch.map(async (email) => {
						try {
							...
							// Ensure association with selected groups even if contact already existed
