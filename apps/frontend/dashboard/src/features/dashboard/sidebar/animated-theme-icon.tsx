	...
	return (
		...
		>
			...
			<g
				className={cn(
					hinge,
					"motion-safe:group-data-[animating=true]:animate-theme-bar-1",
				)}
			>
				<path
			...
			<g
				className={cn(
					hinge,
					"motion-safe:group-data-[animating=true]:animate-theme-bar-2",
				)}
			>
				<path
			...
			<g
				className={cn(
					hinge,
					"motion-safe:group-data-[animating=true]:animate-theme-bar-3",
				)}
			>
				<path
