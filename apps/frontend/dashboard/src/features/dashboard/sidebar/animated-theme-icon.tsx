...
export function AnimatedThemeIcon({ className }: AnimatedThemeIconProps) {
	return (
		...
		>
			...
			<g className={cn(hinge, "motion-safe:group-data-[animating=true]:animate-theme-bar-1")}>
				<path
			...
			{/* 2 — fan page */}
			<g className={cn(hinge, "motion-safe:group-data-[animating=true]:animate-theme-bar-2")}>
				<path
			...
			{/* 3 — bottom page */}
			<g className={cn(hinge, "motion-safe:group-data-[animating=true]:animate-theme-bar-3")}>
				<path
