	...
	return (
		...
		>
			...
			<path
				...
				className="motion-safe:group-hover:animate-workspace-build"
			/>
			...
			<path
				...
				className="motion-safe:group-hover:animate-workspace-window-1"
			/>
			<path
				...
				className="motion-safe:group-hover:animate-workspace-window-2"
			/>
			<path
			...
			<path
				...
				className="motion-safe:group-hover:animate-workspace-window-3"
			/>
			<path
			...
			<path
				...
				className="motion-safe:group-hover:animate-workspace-window-4"
			/>
		</svg>
	);
}
