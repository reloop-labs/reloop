...
export const DomainAddedAlert: React.FC<DomainAddedAlertProps> = ({
	...
	return (
		<div className="mb-6 flex items-start gap-3 rounded-xl border border-stroke-soft-100 bg-bg-weak-50/50 px-4 py-3 dark:border-stroke-soft-100/40 dark:bg-bg-weak-50/20">
