		...
		<div className="w-full">
			...
			<div className="mb-3 flex items-center justify-between">
				...
				<span className="text-[10px] text-text-sub-600">
					{publicSiblings.length + (channel.visibility === "public" ? 1 : 0)} public channel
					{(publicSiblings.length + (channel.visibility === "public" ? 1 : 0)) !== 1 ? "s" : ""}
				</span>
			</div>
			...
			{/* Warning note for private channel */}
			{channel.visibility === "private" && (
				<div className="mt-4 rounded-xl border border-warning-base/20 bg-warning-base/5 p-3">
					<p className="flex items-center gap-1.5 text-[11px] leading-relaxed text-warning-base">
						<svg
						...
						<span>
							This channel is currently <strong>Private</strong>. It will be hidden from the public
							preferences page until you change its visibility to Public.
						</span>
					</p>
				</div>
			)}
