...
export const PreferencesPreview = ({
	...
	const displayName = name.trim() || "Your Channel Name";
		...
		<div className="flex flex-col gap-3">
			...
			<div className="overflow-hidden rounded-2xl border border-stroke-soft-200 bg-bg-white-0 shadow-sm">
				...
				<div className="p-4">
					...
					{/* Channel card — what the contact sees */}
					<PreviewChannelCard
						name={displayName}
...
/* ─── Channel Card inside Preview ─── */
const PreviewChannelCard = ({
	name,
	description,
	isSubscribed,
	visibility,
