			...
			>
				<div className="flex flex-col gap-6">
					...
					<div className="flex flex-col gap-1.5">
						<Label.Root htmlFor="channel-name" className="font-medium text-sm">
							Channel Name
					...
					<div className="relative flex flex-col gap-1.5">
						...
						<Textarea.Root
							...
							placeholder="Briefly describe what contacts can expect from this channel..."
							rows={3}
							disabled={isCreating}
								...
								<div>
									...
									<p className="mt-0.5 text-paragraph-xs text-text-soft-400">
										{defaultSubscription === "opt_in"
											...
											: "Contacts must be manually added to this channel"}
									</p>
								</div>
							</div>
							<Switch.Root
				...
				<div className="mt-8 flex items-center justify-end gap-3 border-stroke-soft-100 border-t pt-5">
					<Button.Root
						...
						mode="stroke"
						size="xsmall"
						onClick={() => router.push("/contacts/channels")}
						disabled={isCreating}
					>
						Cancel
					</Button.Root>
