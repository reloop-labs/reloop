	...
	return (
		<div className="mt-10">
			...
			<div className="overflow-hidden rounded-2xl border border-stroke-soft-200 shadow-sm">
				{/* Browser bar */}
				<div className="flex items-center gap-3 border-stroke-soft-200 border-b bg-bg-white-0 px-4 py-3">
					{/* Traffic lights */}
				...
				>
					...
					<div className="px-6 py-7">
						...
						<div className="mb-5">
							...
							>
								Choose which emails you'd like to receive. Changes save
								automatically.
							</p>
						</div>
				...
				{/* Preview footer note */}
				<div className="flex items-center justify-between border-stroke-soft-200 border-t bg-bg-white-0 px-4 py-2.5">
					<p className="text-[10px] text-text-sub-600">
						{channel.visibility === "private" ? (
							<span className="flex items-center gap-1 text-warning-base">
								...
								This channel is private — it won't appear on the preferences
								page
							</span>
						) : (
