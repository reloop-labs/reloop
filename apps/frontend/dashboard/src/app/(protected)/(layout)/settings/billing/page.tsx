				...
				<div className="rounded-xl border border-stroke-soft-200 bg-white p-6 shadow-sm">
					...
					<div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-3">
						...
						<div className="space-y-1">
							...
							<p className="font-medium text-label-sm text-text-strong-950">Monthly</p>
						</div>
						<div className="space-y-1">
							<p className="text-paragraph-xs text-text-sub-600">Amount</p>
							<p className="font-medium text-label-sm text-text-strong-950">$29.00</p>
						</div>
					</div>
				</div>
				...
				<div className="mt-10">
					...
					<div className="mt-4 overflow-hidden rounded-xl border border-stroke-soft-200 bg-white">
						<table className="w-full text-left text-sm">
							<thead className="bg-neutral-alpha-5 border-b border-stroke-soft-200">
								<tr>
									...
									<th className="px-4 py-3 text-right font-medium text-text-sub-600">Invoice</th>
								</tr>
							</thead>
							<tbody className="divide-y divide-stroke-soft-200">
								{[
									...
									<tr key={invoice.date} className="hover:bg-neutral-alpha-5/5 transition-colors">
										<td className="px-4 py-3 text-text-strong-950">{invoice.date}</td>
										<td className="px-4 py-3 text-text-strong-950">{invoice.amount}</td>
