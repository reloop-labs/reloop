...
import { AddAudience } from "./add-audience";
import { AudienceGroupHeader } from "./audience-group-header";
...
export const AudienceList = ({ groupId }: AudienceListProps) => {
	...
	return (
		<div className="mx-auto max-w-3xl">
			<AudienceGroupHeader group={groupData} isLoading={groupLoading} />
