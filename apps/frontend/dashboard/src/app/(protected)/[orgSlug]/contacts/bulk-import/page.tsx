          ...
          <div className="mt-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="rounded-xl border border-stroke-soft-200 p-6">
                ...
                <div className="font-bold text-2xl text-success-base">{importResult.created}</div>
              </div>
              <div className="rounded-xl border border-stroke-soft-200 p-6">
                <div className="mb-2 flex items-center gap-2">
                ...
                <div className="font-bold text-2xl text-text-sub-600">{importResult.skipped}</div>
              </div>
            </div>
          </div>
        )}
