...
export const PropertyFilterDropdown = ({ value, onChange }: PropertyFilterDropdownProps) => {
    ...
    <Dropdown.Root open={isOpen} onOpenChange={setIsOpen}>
      ...
      <Dropdown.Content align="start" className="w-44 p-3">
        ...
        <div className="flex items-center justify-between pb-2 border-b border-stroke-soft-200 px-1">
          <span className="text-xs text-text-sub-600 font-medium whitespace-nowrap">Filter by</span>
          <button
            type="button"
            onClick={handleReset}
