	...
	return (
		<div className="flex min-h-[calc(100vh-64px)] w-full">
			<div className="flex w-full flex-col lg:w-1/2">
				<div className="mx-auto w-full max-w-2xl px-6 pt-10 pb-8 sm:px-12">
					<AnimatedBackButton />
					<div className="mb-6 border-stroke-soft-200 border-b border-dashed pt-6 pb-6">
						<div>
				...
				{/* Sticky Note Pro Tip at the bottom left */}
					<div className="relative mt-10 mb-10 w-full sm:w-96">
						...
						<div className="relative rotate-1 rounded-lg border border-stroke-soft-200 bg-bg-weak-50/50 p-5 shadow-lg transition-transform duration-300 hover:rotate-0 hover:scale-[1.02]">
			...
			{/* Right side preview */}
			<div className="relative hidden w-1/2 flex-1 overflow-hidden border-stroke-soft-100 border-l bg-bg-weak-50/10 lg:flex">
				<div className="fade-in slide-in-from-bottom-8 relative z-10 w-full animate-in duration-700">
					<div className="flex h-full items-center justify-center p-8">
						<DomainPreview domain={watch("domain")} />
					</div>
				</div>
			</div>
		</div>
