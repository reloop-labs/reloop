...
const response = await fetch('/api/contacts/v1/topics/create', {
  method: 'POST',
  headers: {
...
const response = await fetch('/api/contacts/v1/topics/topic_123', {
  method: 'DELETE',
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY'
  }
...
const response = await fetch('/api/contacts/v1/enrollments/subscribe', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json',
    'Authorization': 'Bearer YOUR_API_KEY'
...
response = requests.post('/api/contacts/v1/topics/create',
  headers={
    'Content-Type': 'application/json',
    'Authorization': 'Bearer YOUR_API_KEY'
  },
...
response = requests.delete('/api/contacts/v1/topics/topic_123',
  headers={
    'Authorization': 'Bearer YOUR_API_KEY'
  }
)
...
response = requests.post('/api/contacts/v1/enrollments/subscribe',
  headers={
    'Content-Type': 'application/json',
    'Authorization': 'Bearer YOUR_API_KEY'
  },
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, '/api/contacts/v1/topics/create');
...
// Delete a topic
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, '/api/contacts/v1/topics/topic_123');
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, '/api/contacts/v1/enrollments/subscribe');
curl_setopt($ch, CURLOPT_POST, true);
curl_setopt($ch, CURLOPT_POSTFIELDS, json_encode($data));
curl_setopt($ch, CURLOPT_HTTPHEADER, [
    'Content-Type: application/json',
...
const operations = [
	{
		...
		label: "Create Topic",
		method: "POST",
		endpoint: "/api/contacts/v1/topics/create",
	},
	{
		id: "list",
		label: "List Topics",
	...
	},
	{
		...
		label: "Subscribe",
		method: "POST",
		endpoint: "/api/contacts/v1/enrollments/subscribe",
	},
	{
		id: "delete",
		label: "Delete Topic",
		method: "DELETE",
		endpoint: "/api/contacts/v1/topics/:topic_id",
	},
];
