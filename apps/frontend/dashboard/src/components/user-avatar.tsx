...
/**
 * Stable user avatar: always keeps a gradient+initials fallback under the
 * photo so a failed/slow/expired image URL never leaves an empty circle.
 */
export function UserAvatar({
	...
	return (
		...
		>
			{/* Always render initials underneath so failed images don't go blank. */}
			<div
			...
			{showImage ? (
				// eslint-disable-next-line @next/next/no-img-element -- remote OAuth/upload URLs
				<img
					src={imageSrc}
					alt={label}
