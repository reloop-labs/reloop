...
async function testGemmaAIIntegration() {
	console.log(
		"🚀 Testing Reloop Backend AI Route logic with Google Gemma 2 9B (gemma2:9b)...\n",
	);
	...
	const bodyText =
		"Hi team, please find attached the Q3 sales report. Sales grew by 35% year-over-year. Let's discuss in our meeting tomorrow.";
	...
	const composePrompt =
		"Compose a professional email thanking Sarah for organizing the successful team offsite event.";
	const contextParts = [
		"Subject: Thank you for the offsite!",
