...
export const listSentMessagesXCodeSamples: CodeSample[] = [
	{
		id: "node",
		lang: "javascript",
		label: "Node.js",
...
const { messages, messageError } = await reloop.inbox.messages.listSent({
...
if (messageError) throw messageError;`,
	},
	{
		...
		lang: "bash",
		label: "cURL",
		source: `curl -X GET "https://reloop.sh/api/inbox/v1/messages/sent?mailboxId=mbx_123456789" \
...
result = reloop.inbox.messages.listSent({
  "mailboxId": "mbx_123456789",
})
