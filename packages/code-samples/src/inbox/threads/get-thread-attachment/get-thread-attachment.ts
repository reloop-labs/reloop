...
export const getThreadAttachmentXCodeSamples: CodeSample[] = [
	{
		id: "node",
		lang: "javascript",
		label: "Node.js",
...
$thread = $reloop->inbox->threads->getAttachment('thr_123456789', 'att_123456789');`,
	},
			{
		id: "java",
		lang: "java",
...
var thread = reloop.inbox.threads.getAttachment("thr_123456789", "att_123456789");`,
	},
	{
		id: "dotnet",
		lang: "csharp",
