...
export const getContactXCodeSamples: CodeSample[] = [
	{
		id: "node",
		lang: "javascript",
		label: "Node.js",
...
result = reloop.contacts.get("con_123456789")
...
await reloop.Contacts.GetAsync("con_123456789");`,
	},
	{
		id: "go",
		lang: "go",
...
_, _ = client.Contacts.Get("con_123456789")`,
	},
	{
		id: "rust",
		lang: "rust",
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    reloop.contacts().get("con_123456789").await?;
...
{:ok, result} = Reloop.Services.Contacts.get(client, "con_123456789")`,
	},
];
