...
export const deleteContactXCodeSamples: CodeSample[] = [
	{
		id: "node",
		lang: "javascript",
		label: "Node.js",
...
$contact = $reloop->contacts->delete('con_123456789');`,
	},
	{
		id: "java",
		lang: "java",
...
var contact = reloop.contacts.delete("con_123456789");`,
	},
	{
		id: "dotnet",
		lang: "csharp",
...
await reloop.Contacts.DeleteAsync("con_123456789");`,
	},
	{
		id: "go",
		lang: "go",
...
_, _ = client.Contacts.Delete("con_123456789")`,
	},
	{
		id: "rust",
		lang: "rust",
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    reloop.contacts().delete("con_123456789").await?;
...
{:ok, result} = Reloop.Services.Contacts.delete(client, "con_123456789")`,
	},
];
