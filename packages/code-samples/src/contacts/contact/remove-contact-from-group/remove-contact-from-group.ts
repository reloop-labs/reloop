...
export const removeContactFromGroupXCodeSamples: CodeSample[] = [
	{
		id: "node",
		lang: "javascript",
		label: "Node.js",
...
{:ok, result} = Reloop.Services.ContactGroups.remove_contact(client, "grp_123456789", %{contact_id: "con_123456789"})`,
	},
];
