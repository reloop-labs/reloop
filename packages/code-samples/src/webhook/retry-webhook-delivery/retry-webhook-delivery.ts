...
export const retryWebhookDeliveryXCodeSamples: CodeSample[] = [
	{
		id: "node",
		lang: "javascript",
		label: "Node.js",
...
result = reloop.webhook.retryDelivery("del_123456789")
...
$webhook = $reloop->webhook->retryDelivery('del_123456789');`,
	},
			{
		id: "java",
		lang: "java",
...
var webhook = reloop.webhook.retryDelivery("del_123456789");`,
	},
	{
		id: "dotnet",
		lang: "csharp",
