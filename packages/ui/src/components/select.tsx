...
export const selectVariants = tv({
	slots: {
		triggerRoot: [
			// base
			"group/trigger min-w-0 shrink-0 bg-bg-white-0 outline-none ring-1 ring-inset ring-stroke-soft-100 dark:ring-stroke-soft-100",
	...
	(
		...
		<SelectPrimitives.Portal>
			<SelectPrimitives.Content
				...
				className={cn(
					// base
					"relative z-50 overflow-hidden rounded-2xl bg-bg-white-0 shadow-regular-md ring-1 ring-stroke-soft-100 ring-inset dark:ring-stroke-soft-100",
					// widths
