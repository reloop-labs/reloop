...
load_existing_values() {
	...
	for key in RELOOP_VERSION RELOOP_DOMAIN RELOOP_ADMIN_EMAIL RELOOP_PUBLIC_IP \
		...
		WEBHOOK_ENCRYPTION_KEY WORKBENCH_USER WORKBENCH_PASS S3_ENDPOINT S3_ACCESS_KEY S3_SECRET_KEY \
...
collect_configuration() {
	...
	WORKBENCH_USER="${PRESERVED_WORKBENCH_USER:-admin}"
	preserved_or_new WORKBENCH_PASS gen_secret 32
